...
<head>
    ...
    <meta name="description" content="Play Super Mario 64 - Spencer's Game Collection">
    <title>Super Mario 64 - Spencer's Website</title>
...
<div class="container">
    ...
    <header class="page-header">
        <h1>🎮 Super Mario 64 <span class="game-badge">3D Platformer</span></h1>
        <p>Join Mario on his classic 3D adventure to rescue Princess Peach from Bowser!</p>
    </header>

    <!-- Mario 64 Game Player -->
    <div class="game-player">
        <div class="game-container" id="mario64Container">
            <button class="fullscreen-btn" onclick="toggleFullscreen()">⛶ Fullscreen</button>
            <iframe 
                class="game-iframe"
                sandbox="allow-scripts allow-same-origin allow-popups"
                loading="lazy"
                src="https://thespencergamingwebsite.com/clmario64webgl.html" 
        ...
        <div class="game-details">
            <h2>🎯 About Super Mario 64</h2>
            <p>Super Mario 64 is the groundbreaking 3D platformer that revolutionized gaming. Join Mario as he explores Princess Peach's castle, jumps into magical paintings, and collects Power Stars to rescue the princess from Bowser's clutches!</p>
            
            <h3>⭐ Game Features</h3>
            <div class="features-grid">
                <div class="feature-item">
                    <strong>🌟 Revolutionary 3D Gameplay</strong>
                    <p>Experience the game that defined 3D platforming with fluid controls</p>
                </div>
                <div class="feature-item">
                    <strong>🏰 Expansive Worlds</strong>
                    <p>Explore 15 diverse courses with unique challenges and secrets</p>
                </div>
                <div class="feature-item">
                    <strong>⭐ Power Star Collection</strong>
                    <p>Collect 120 Power Stars to unlock the full game experience</p>
                </div>
                <div class="feature-item">
                    <strong>🎮 Iconic Characters</strong>
                    <p>Meet Mario, Luigi, Yoshi, and other classic Nintendo characters</p>
                </div>
            </div>
            ...
            <div style="background: linear-gradient(135deg, rgba(255,255,255,0.1) 0%, rgba(255,107,107,0.1) 100%); padding: 20px; border-radius: 10px; border-left: 5px solid #4ECDC4; margin: 20px 0;">
                ...
                <ul>
                    <li><strong>WASD / Arrow Keys</strong> - Move Mario</li>
                    <li><strong>Spacebar</strong> - Jump</li>
                    <li><strong>Shift / Z</strong> - Crouch/Crawl</li>
                    <li><strong>Mouse</strong> - Control camera view</li>
                    <li><strong>E / C</strong> - Punch/Kick attacks</li>
                    <li><strong>R</strong> - Change camera mode</li>
                </ul>
                
                <p><strong>Advanced Moves:</strong></p>
                <ul>
                    <li><strong>Triple Jump</strong> - Press jump three times while running</li>
                    <li><strong>Long Jump</strong> - Crouch + Jump while running</li>
                    <li><strong>Backflip</strong> - Crouch + Jump while stationary</li>
                    <li><strong>Wall Jump</strong> - Jump toward wall, then jump again</li>
                </ul>
            </div>

            <h3>💡 Gameplay Tips</h3>
            <ul style="color: #f8f9fa; font-size: 16px; font-weight: 500; line-height: 1.7; padding-left: 20px;">
                <li>Explore every corner of each course - <strong>secrets are everywhere</strong></li>
                <li>Master Mario's various <strong>jumping techniques</strong> for hard-to-reach areas</li>
                <li>Pay attention to <strong>camera angles</strong> to spot hidden platforms</li>
                <li>Talk to <strong>Toads in the castle</strong> for hints and tips</li>
                <li>Some stars require <strong>specific cap powers</strong> - Wing Cap, Metal Cap, or Vanish Cap</li>
            </ul>

            <h3>🏆 Objectives</h3>
            <ul style="color: #f8f9fa; font-size: 16px; font-weight: 500; line-height: 1.7; padding-left: 20px;">
                <li>Collect Power Stars by completing challenges in each course</li>
                <li>Defeat Bowser in three epic boss battles</li>
                <li>Unlock all 15 courses by collecting enough stars</li>
                <li>Find Yoshi on the castle roof for a special reward</li>
                <li>Achieve 100% completion with all 120 stars</li>
            </ul>

            <h3>🎨 Course Highlights</h3>
            <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(200px, 1fr)); gap: 15px; margin: 20px 0;">
                <div style="background: rgba(255,255,255,0.1); padding: 15px; border-radius: 8px; border-top: 4px solid #FF6B6B;">
                    <strong>Bob-omb Battlefield</strong>
                    <p>The first course with rolling hills and King Bob-omb</p>
                </div>
                <div style="background: rgba(255,255,255,0.1); padding: 15px; border-radius: 8px; border-top: 4px solid #4ECDC4;">
                    <strong>Whomp's Fortress</strong>
                    <p>Floating fortress with giant Whomps to defeat</p>
                </div>
                <div style="background: rgba(255,255,255,0.1); padding: 15px; border-radius: 8px; border-top: 4px solid #8b5cf6;">
                    <strong>Cool, Cool Mountain</strong>
                    <p>Snowy mountain with slippery slopes and penguins</p>
                </div>
                <div style="background: rgba(255,255,255,0.1); padding: 15px; border-radius: 8px; border-top: 4px solid #10b981;">
                    <strong>Big Boo's Haunt</strong>
                    <p>Spooky mansion filled with ghosts and secrets</p>
                </div>
            </div>
            ...
            <div style="background: linear-gradient(135deg, rgba(255,107,107,0.2), rgba(78,205,196,0.2)); border: 2px solid #FF6B6B; border-radius: 10px; padding: 20px; margin-top: 25px; text-align: center;">
                ...
                <p style="color: #f8f9fa; font-weight: 500; margin: 0;">The castle itself is full of secrets! Try ground pounding suspicious spots, looking behind paintings, and exploring every room. Some of the most rewarding discoveries are hidden in plain sight within the castle walls.</p>
            </div>
        </div>
    </div>
    ...
    <script>
        ...
        function toggleFullscreen() {
            const gameContainer = document.getElementById('mario64Container');
    ...
    <div id="reportGameModal" style="display:none;position:fixed;inset:0;z-index:9999;background:rgba(0,0,0,0.8);align-items:center;justify-content:center;padding:20px;">
        <div style="background:linear-gradient(135deg,#0f172a,#1e293b);border:1px solid rgba(239,68,68,0.3);border-radius:14px;padding:28px;max-width:440px;width:100%;color:#e2e8f0;">
            ...
            <p style="color:#94a3b8;font-size:0.85rem;margin-bottom:14px;">Game: <strong>super</strong></p>
            ...
            <div style="display:flex;gap:8px;">
                <button onclick="submitGameReport('super')" style="flex:1;padding:10px;border:none;border-radius:8px;background:linear-gradient(135deg,#ef4444,#dc2626);color:#fff;font-weight:600;cursor:pointer;">Submit Report</button>
