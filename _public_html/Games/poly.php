...
<head>
    ...
    <meta name="description" content="Play Poly Track - Spencer's Game Collection">
    <title>Poly Track - Spencer's Website</title>
...
<body data-backgrounds='<?php echo htmlspecialchars(json_encode($available_backgrounds), ENT_QUOTES, 'UTF-8'); ?>'
    ...
    <header class="page-header">
        <h1>🏎️💨 Poly Track <span class="game-badge">Low-Poly Racer</span></h1>
        <p>Race through loops, jumps, and high-speed tracks where every millisecond counts!</p>
    </header>

    <!-- Poly Track Game Player -->
    <div class="game-player">
        <div class="game-container" id="gameContainer">
            ...
            <iframe
                ...
                loading="lazy"
                src="https://searchprox.global.ssl.fastly.net/public/assets/games/poly-track/"
        ...
        <div class="game-details">
            <h2>🏎️💨 About Poly Track</h2>
            <p>Poly Track is a fast-paced, low-poly racing game created by Kodub, heavily inspired by the legendary TrackMania series. Race against the clock on thrilling tracks filled with loops, jumps, sharp turns, and high-speed straights where every millisecond counts! The game features smooth physics-based driving, a powerful built-in level editor to design and share your own tracks, vehicle customization, and global leaderboards. Whether you're chasing the perfect lap time or building the ultimate custom course, Poly Track delivers endless racing fun.</p>

            <h3>⭐ Game Features</h3>
            <div class="features-grid">
                <div class="feature-item">
                    <strong>🏁 Time Trial Racing</strong>
                    <p>Race against the clock on 13+ official tracks and endless community courses</p>
                </div>
                <div class="feature-item">
                    <strong>🛠️ Level Editor</strong>
                    <p>Build custom tracks with loops, ramps, and obstacles, then share them</p>
                </div>
                <div class="feature-item">
                    <strong>🎨 Vehicle Customization</strong>
                    <p>Personalize your car's primary, secondary, frame, and rim colors</p>
                </div>
                <div class="feature-item">
                    <strong>🌍 Global Leaderboards</strong>
                    <p>Compete worldwide and race against ghost replays of top players</p>
                </div>
            </div>
            ...
            <div style="background: linear-gradient(135deg, rgba(255,255,255,0.1) 0%, rgba(0,191,255,0.1) 100%); padding: 20px; border-radius: 10px; border-left: 5px solid #00BFFF; margin: 20px 0;">
                <p><strong>Racing Controls:</strong></p>
                <ul>
                    ...
                    <li><strong>R / Enter</strong> — Restart the track</li>
                    <li><strong>Tab</strong> — View leaderboard</li>
                </ul>

                <p><strong>Level Editor Controls:</strong></p>
                <ul>
                    <li><strong>Left Mouse Button</strong> — Place track pieces</li>
                    <li><strong>Middle Mouse Button</strong> — Rotate the camera view</li>
                    <li><strong>Right Mouse Button</strong> — Pan the camera</li>
                    <li><strong>Shift + Scroll Wheel</strong> — Adjust elevation up or down</li>
                </ul>
            </div>

            <h3>🗺️ Track Environments</h3>
            <div style="background: rgba(0,0,0,0.3); padding: 20px; border-radius: 10px; margin: 20px 0;">
                <p style="margin-bottom: 15px;">Race through colorful low-poly worlds with distinct scenery:</p>
                <div style="display: flex; gap: 10px; flex-wrap: wrap;">
                    <span class="difficulty-badge difficulty-easy">Summer</span>
                    <span class="difficulty-badge difficulty-medium">Desert</span>
                    <span class="difficulty-badge difficulty-hard">Winter</span>
                    <span class="difficulty-badge difficulty-insane">Community Tracks</span>
                </div>
            </div>

            <h3>💡 Tips &amp; Strategies</h3>
            <ul style="color: #f8f9fa; font-size: 16px; font-weight: 500; line-height: 1.7; padding-left: 20px;">
                <li>Focus on finding the ideal racing line — smooth turns are faster than sharp corrections!</li>
                <li>Start slow to learn a track's layout, then gradually push for faster times</li>
                <li>Use the handbrake (Space) to drift through tight corners without losing too much speed</li>
                <li>Watch ghost replays of top leaderboard players to learn optimal routes and techniques</li>
                <li>Replay tracks multiple times — each run helps you refine your approach and shave off milliseconds</li>
                <li>Building your own tracks in the editor helps you understand how obstacles affect movement</li>
            </ul>

            <h3>🛠️ Level Editor Guide</h3>
            <ul style="color: #f8f9fa; font-size: 16px; font-weight: 500; line-height: 1.7; padding-left: 20px;">
                <li><strong>Getting Started:</strong> Open the Editor from the main menu and start placing track pieces on the grid</li>
                <li><strong>Track Pieces:</strong> Choose from ramps, loops, curves, straights, checkpoints, and more</li>
                <li><strong>Elevation:</strong> Use Shift + Scroll Wheel to raise or lower pieces for multi-level tracks</li>
                <li><strong>Testing:</strong> Race your track at any time during building to test the flow and difficulty</li>
                <li><strong>Sharing:</strong> Export your finished track as a code and share it with the community</li>
                <li><strong>Importing:</strong> Paste track codes from other players to race their custom creations</li>
            </ul>

            <h3>🏁 Game Modes</h3>
            <ul style="color: #f8f9fa; font-size: 16px; font-weight: 500; line-height: 1.7; padding-left: 20px;">
                <li><strong>Official Tracks:</strong> 13+ pre-designed courses with increasing difficulty and global leaderboards</li>
                <li><strong>Community Tracks:</strong> 30+ player-created courses with new ones being shared constantly</li>
                <li><strong>Track Editor:</strong> Design your own tracks from scratch using a full suite of building tools</li>
                <li><strong>Ghost Racing:</strong> Challenge leaderboard players asynchronously by racing against their ghost replays</li>
                <li><strong>Customization:</strong> Personalize your car's colors before hitting the track</li>
            </ul>
            ...
            <div style="background: linear-gradient(135deg, rgba(0,191,255,0.2), rgba(255,215,0,0.2)); border: 2px solid #FFD700; border-radius: 10px; padding: 20px; margin-top: 25px; text-align: center;">
                ...
                <p style="color: #f8f9fa; font-weight: 500; margin: 0;">Every millisecond counts in Poly Track! Avoid unnecessary braking and steering — smooth, minimal inputs keep your speed high. Select a top player from the leaderboard and race against their ghost to see exactly where you can improve your racing line!</p>
            </div>
        </div>
    </div>
    ...
    <div id="reportGameModal" style="display:none;position:fixed;inset:0;z-index:9999;background:rgba(0,0,0,0.8);align-items:center;justify-content:center;padding:20px;">
        <div style="background:linear-gradient(135deg,#0f172a,#1e293b);border:1px solid rgba(239,68,68,0.3);border-radius:14px;padding:28px;max-width:440px;width:100%;color:#e2e8f0;">
            ...
            <p style="color:#94a3b8;font-size:0.85rem;margin-bottom:14px;">Game: <strong>poly</strong></p>
            ...
            <div style="display:flex;gap:8px;">
                <button onclick="submitGameReport('poly')" style="flex:1;padding:10px;border:none;border-radius:8px;background:linear-gradient(135deg,#ef4444,#dc2626);color:#fff;font-weight:600;cursor:pointer;">Submit Report</button>
