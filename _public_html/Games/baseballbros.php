...
<head>
    ...
    <meta name="description" content="Baseball Bros - Spencer's Game Collection">
    <title>Baseball Bros - Spencer's Website</title>
...
<body data-backgrounds='<?php echo htmlspecialchars(json_encode($available_backgrounds), ENT_QUOTES, 'UTF-8'); ?>'
    ...
    <header class="page-header">
        <h1>Baseball Bros <span class="game-badge">Arcade</span></h1>
    ...
    <div class="game-player">
        <div class="game-container" id="gameContainer">
            ...
            <iframe
                ...
                loading="lazy"
                src="https://thespencergamingwebsite.com/clbaseballbros.html"
        ...
        <div class="game-details">
            <h2>About Baseball Bros</h2>
            <p>Baseball Bros is an exciting arcade-style baseball game where you step up to the plate and try to hit as many home runs as possible. Simple controls, addictive gameplay!</p>

            <h3>Game Features</h3>
            <div class="features-grid">
                <div class="feature-item">
                    <strong>Simple Controls</strong>
                    <p>Easy to learn, hard to master batting mechanics</p>
                </div>
                <div class="feature-item">
                    <strong>High Score Challenge</strong>
                    <p>Compete for the highest home run count</p>
                </div>
                <div class="feature-item">
                    <strong>Fun Graphics</strong>
                    <p>Colorful and engaging visual style</p>
                </div>
                <div class="feature-item">
                    <strong>Quick Games</strong>
                    <p>Perfect for short gaming sessions</p>
                </div>
            </div>
            ...
            <div style="background: linear-gradient(135deg, rgba(255,255,255,0.1) 0%, rgba(78,205,196,0.1) 100%); padding: 20px; border-radius: 10px; border-left: 5px solid #FF6B6B; margin: 20px 0;">
                ...
                <ul>
                    <li>Click or tap to swing the bat</li>
                    <li>Time your swing perfectly to hit home runs</li>
                    <li>Watch the pitcher's throw carefully</li>
                </ul>
            </div>

            <h3>Gameplay Tips</h3>
            <ul style="color: #f8f9fa; font-size: 16px; font-weight: 500; line-height: 1.7; padding-left: 20px;">
                <li>Watch the ball trajectory carefully</li>
                <li>Time your swing for maximum power</li>
                <li>Practice to improve your timing</li>
                <li>Aim for the sweet spot on the bat</li>
            </ul>

            <h3>Objectives</h3>
            <ul style="color: #f8f9fa; font-size: 16px; font-weight: 500; line-height: 1.7; padding-left: 20px;">
                <li>Hit as many home runs as possible</li>
                <li>Beat your high score</li>
                <li>Perfect your timing</li>
                <li>Become a baseball champion</li>
            </ul>
            ...
            <div style="background: linear-gradient(135deg, rgba(255,107,107,0.2), rgba(78,205,196,0.2)); border: 2px solid #4ECDC4; border-radius: 10px; padding: 20px; margin-top: 25px; text-align: center;">
                ...
                <p style="color: #f8f9fa; font-weight: 500; margin: 0;">Keep your eye on the ball and swing just before it reaches you for the best results!</p>
            </div>
        </div>
    ...
    <div id="reportGameModal" style="display:none;position:fixed;inset:0;z-index:9999;background:rgba(0,0,0,0.8);align-items:center;justify-content:center;padding:20px;">
        <div style="background:linear-gradient(135deg,#0f172a,#1e293b);border:1px solid rgba(239,68,68,0.3);border-radius:14px;padding:28px;max-width:440px;width:100%;color:#e2e8f0;">
            ...
            <p style="color:#94a3b8;font-size:0.85rem;margin-bottom:14px;">Game: <strong>baseballbros</strong></p>
            ...
            <div style="display:flex;gap:8px;">
                <button onclick="submitGameReport('baseballbros')" style="flex:1;padding:10px;border:none;border-radius:8px;background:linear-gradient(135deg,#ef4444,#dc2626);color:#fff;font-weight:600;cursor:pointer;">Submit Report</button>
