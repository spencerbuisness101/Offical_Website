...
<head>
    ...
    <meta name="description" content="Paper.io - Spencer's Game Collection">
    <title>Paper.io - Spencer's Website</title>
...
<body data-backgrounds='<?php echo htmlspecialchars(json_encode($available_backgrounds), ENT_QUOTES, 'UTF-8'); ?>' data-active-background='<?php echo $active_designer_background ? htmlspecialchars($active_designer_background['image_url'], ENT_QUOTES, 'UTF-8') : ''; ?>'>
    ...
    <header class="page-header">
        <h1>Paper.io <span class="game-badge">Strategy</span></h1>
    ...
    <div class="game-player">
        <div class="game-container" id="gameContainer">
            ...
            <iframe class="game-iframe"
                ...
                loading="lazy" src="https://thespencergamingwebsite.com/clpaperio.html" allow="autoplay; encrypted-media; fullscreen" allowfullscreen id="gameIframe"></iframe>
        </div>

        <div class="game-details">
            <h2>About Paper.io</h2>
            <p>Paper.io is an addictive multiplayer territory conquest game. Move around the map to expand your territory while avoiding other players who can eliminate you by crossing your trail!</p>

            <h3>Game Features</h3>
            <div class="features-grid">
                <div class="feature-item"><strong>Territory Control</strong><p>Claim land by creating closed shapes</p></div>
                <div class="feature-item"><strong>Competitive Play</strong><p>Compete against other players for map control</p></div>
                <div class="feature-item"><strong>Simple Mechanics</strong><p>Easy to understand, strategic gameplay</p></div>
                <div class="feature-item"><strong>Leaderboard</strong><p>Climb the ranks by controlling more territory</p></div>
            </div>
            ...
            <div style="background: linear-gradient(135deg, rgba(255,255,255,0.1) 0%, rgba(78,205,196,0.1) 100%); padding: 20px; border-radius: 10px; border-left: 5px solid #FF6B6B; margin: 20px 0;">
                ...
                <ul>
                    ...
                    <li>Move outside your territory to claim new land</li>
                    <li>Return to your territory to complete the claim</li>
                    <li>Avoid getting hit on your trail!</li>
                </ul>
            </div>

            <h3>Gameplay Tips</h3>
            <ul style="color: #f8f9fa; font-size: 16px; font-weight: 500; line-height: 1.7; padding-left: 20px;">
                <li>Make small, safe captures rather than risky large ones</li>
                <li>Watch out for opponents near your trail</li>
                <li>Target other players' trails when they're vulnerable</li>
                <li>Stay near your territory for quick escapes</li>
            </ul>
            ...
            <div style="background: linear-gradient(135deg, rgba(255,107,107,0.2), rgba(78,205,196,0.2)); border: 2px solid #4ECDC4; border-radius: 10px; padding: 20px; margin-top: 25px; text-align: center;">
                ...
                <p style="color: #f8f9fa; font-weight: 500; margin: 0;">Your trail is your weakness - the longer it is, the more vulnerable you become!</p>
            </div>
        </div>
    ...
    <div id="reportGameModal" style="display:none;position:fixed;inset:0;z-index:9999;background:rgba(0,0,0,0.8);align-items:center;justify-content:center;padding:20px;">
        <div style="background:linear-gradient(135deg,#0f172a,#1e293b);border:1px solid rgba(239,68,68,0.3);border-radius:14px;padding:28px;max-width:440px;width:100%;color:#e2e8f0;">
            ...
            <p style="color:#94a3b8;font-size:0.85rem;margin-bottom:14px;">Game: <strong>paperio</strong></p>
            ...
            <div style="display:flex;gap:8px;">
                <button onclick="submitGameReport('paperio')" style="flex:1;padding:10px;border:none;border-radius:8px;background:linear-gradient(135deg,#ef4444,#dc2626);color:#fff;font-weight:600;cursor:pointer;">Submit Report</button>
