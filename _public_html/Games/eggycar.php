...
<head>
    ...
    <meta name="description" content="Eggy Car - Spencer's Game Collection">
    <title>Eggy Car - Spencer's Website</title>
...
<body data-backgrounds='<?php echo htmlspecialchars(json_encode($available_backgrounds), ENT_QUOTES, 'UTF-8'); ?>' data-active-background='<?php echo $active_designer_background ? htmlspecialchars($active_designer_background['image_url'], ENT_QUOTES, 'UTF-8') : ''; ?>'>
    ...
    <header class="page-header">
        <h1>Eggy Car <span class="game-badge">Arcade</span></h1>
    ...
    <div class="game-player">
        <div class="game-container" id="gameContainer">
            ...
            <iframe class="game-iframe"
                ...
                loading="lazy" src="https://thespencergamingwebsite.com/cleggycar.html" allow="autoplay; encrypted-media; fullscreen" allowfullscreen id="gameIframe"></iframe>
        </div>

        <div class="game-details">
            <h2>About Eggy Car</h2>
            <p>Eggy Car is a fun physics-based driving game where you must transport a fragile egg on top of your car without letting it fall. Navigate through hilly terrain while keeping your precious cargo safe!</p>

            <h3>Game Features</h3>
            <div class="features-grid">
                <div class="feature-item"><strong>Physics-Based</strong><p>Realistic physics make every bump count</p></div>
                <div class="feature-item"><strong>Challenging Terrain</strong><p>Hills and obstacles test your driving skills</p></div>
                <div class="feature-item"><strong>Simple Controls</strong><p>Easy to learn, difficult to master</p></div>
                <div class="feature-item"><strong>High Score Mode</strong><p>How far can you go without dropping the egg?</p></div>
            </div>
            ...
            <div style="background: linear-gradient(135deg, rgba(255,255,255,0.1) 0%, rgba(78,205,196,0.1) 100%); padding: 20px; border-radius: 10px; border-left: 5px solid #FF6B6B; margin: 20px 0;">
                ...
                <ul>
                    <li>Arrow Keys or A/D to accelerate and brake</li>
                    <li>Balance your speed carefully</li>
                    <li>Go slow on steep hills</li>
                </ul>
            </div>

            <h3>Gameplay Tips</h3>
            <ul style="color: #f8f9fa; font-size: 16px; font-weight: 500; line-height: 1.7; padding-left: 20px;">
                <li>Slow down before reaching hills</li>
                <li>Accelerate smoothly, avoid sudden movements</li>
                <li>Use momentum wisely on uphill sections</li>
                <li>Patience is key - slow and steady wins!</li>
            </ul>
            ...
            <div style="background: linear-gradient(135deg, rgba(255,107,107,0.2), rgba(78,205,196,0.2)); border: 2px solid #4ECDC4; border-radius: 10px; padding: 20px; margin-top: 25px; text-align: center;">
                ...
                <p style="color: #f8f9fa; font-weight: 500; margin: 0;">The egg has momentum too! Slow down before downhill sections to prevent it from flying off.</p>
            </div>
        </div>
    ...
    <div id="reportGameModal" style="display:none;position:fixed;inset:0;z-index:9999;background:rgba(0,0,0,0.8);align-items:center;justify-content:center;padding:20px;">
        <div style="background:linear-gradient(135deg,#0f172a,#1e293b);border:1px solid rgba(239,68,68,0.3);border-radius:14px;padding:28px;max-width:440px;width:100%;color:#e2e8f0;">
            ...
            <p style="color:#94a3b8;font-size:0.85rem;margin-bottom:14px;">Game: <strong>eggycar</strong></p>
            ...
            <div style="display:flex;gap:8px;">
                <button onclick="submitGameReport('eggycar')" style="flex:1;padding:10px;border:none;border-radius:8px;background:linear-gradient(135deg,#ef4444,#dc2626);color:#fff;font-weight:600;cursor:pointer;">Submit Report</button>
