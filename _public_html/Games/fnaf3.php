<?php
/**
 * Five Nights at Freddy's 3 - Game Page
 */
...
<head>
    ...
    <meta name="description" content="Five Nights at Freddy's 3 - Spencer's Game Collection">
    <title>FNAF 3 - Spencer's Website</title>
...
<body data-backgrounds='<?php echo htmlspecialchars(json_encode($available_backgrounds), ENT_QUOTES, 'UTF-8'); ?>' data-active-background='<?php echo $active_designer_background ? htmlspecialchars($active_designer_background['image_url'], ENT_QUOTES, 'UTF-8') : ''; ?>'>
    ...
    <header class="page-header">
        <h1>Five Nights at Freddy's 3 <span class="game-badge">FNAF</span></h1>
        <p>30 years later, only Springtrap remains...</p>
    </header>
    ...
    <div class="game-player">
        <div class="game-container" id="gameContainer">
            ...
            <iframe class="game-iframe"
                ...
                loading="lazy" src="https://thespencergamingwebsite.com/clfnaf3.html" allow="autoplay; encrypted-media; fullscreen" allowfullscreen id="gameIframe"></iframe>
        </div>

        <div class="game-details">
            <h2>About Five Nights at Freddy's 3</h2>
            <p>Five Nights at Freddy's 3 takes place 30 years after Freddy Fazbear's Pizza closed. A horror attraction has opened, featuring authentic animatronic relics. But they found something else... Springtrap, containing the soul of a killer.</p>

            <h3>Game Features</h3>
            <div class="features-grid">
                <div class="feature-item"><strong>Single Animatronic</strong><p>Face the terrifying Springtrap</p></div>
                <div class="feature-item"><strong>Phantom Animatronics</strong><p>Hallucinations that can disable your systems</p></div>
                <div class="feature-item"><strong>Ventilation System</strong><p>Manage audio, camera, and ventilation errors</p></div>
                <div class="feature-item"><strong>Audio Lure</strong><p>Use sound to lure Springtrap away</p></div>
            </div>
            ...
            <div style="background: linear-gradient(135deg, rgba(255,255,255,0.1) 0%, rgba(78,205,196,0.1) 100%); padding: 20px; border-radius: 10px; border-left: 5px solid #FF6B6B; margin: 20px 0;">
                ...
                <ul>
                    <li>Mouse to navigate cameras and click buttons</li>
                    <li>Monitor Springtrap through cameras</li>
                    <li>Use audio lures to guide Springtrap away</li>
                    <li>Reboot systems when they fail</li>
                    <li>Seal vents to block Springtrap's path</li>
                </ul>
            </div>

            <h3>Gameplay Tips</h3>
            <ul style="color: #f8f9fa; font-size: 16px; font-weight: 500; line-height: 1.7; padding-left: 20px;">
                <li>Keep track of Springtrap at all times</li>
                <li>Use audio to lure him to far cameras</li>
                <li>Phantom animatronics cause system failures - reboot quickly</li>
                <li>Don't let ventilation stay broken too long</li>
                <li>Seal vents strategically to slow Springtrap down</li>
            </ul>
            ...
            <div style="background: linear-gradient(135deg, rgba(255,107,107,0.2), rgba(78,205,196,0.2)); border: 2px solid #4ECDC4; border-radius: 10px; padding: 20px; margin-top: 25px; text-align: center;">
                ...
                <p style="color: #f8f9fa; font-weight: 500; margin: 0;">This game contains intense horror and jump scares. The story takes a darker turn...</p>
            </div>
        </div>
    ...
    <div id="reportGameModal" style="display:none;position:fixed;inset:0;z-index:9999;background:rgba(0,0,0,0.8);align-items:center;justify-content:center;padding:20px;">
        <div style="background:linear-gradient(135deg,#0f172a,#1e293b);border:1px solid rgba(239,68,68,0.3);border-radius:14px;padding:28px;max-width:440px;width:100%;color:#e2e8f0;">
            ...
            <p style="color:#94a3b8;font-size:0.85rem;margin-bottom:14px;">Game: <strong>fnaf3</strong></p>
            ...
            <div style="display:flex;gap:8px;">
                <button onclick="submitGameReport('fnaf3')" style="flex:1;padding:10px;border:none;border-radius:8px;background:linear-gradient(135deg,#ef4444,#dc2626);color:#fff;font-weight:600;cursor:pointer;">Submit Report</button>
