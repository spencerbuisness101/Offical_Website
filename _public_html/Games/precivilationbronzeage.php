<?php
/**
 * Pre-Civilization Bronze Age - Game Page
...
<head>
    ...
    <meta name="description" content="Pre-Civilization Bronze Age - Spencer's Game Collection">
    <title>Pre-Civilization Bronze Age - Spencer's Website</title>
...
<body data-backgrounds='<?php echo htmlspecialchars(json_encode($available_backgrounds), ENT_QUOTES, 'UTF-8'); ?>'
    ...
    <header class="page-header">
        <h1>🏛️ Pre-Civilization Bronze Age <span class="game-badge">Strategy</span></h1>
        <p>Lead your tribe from stone age to bronze age glory!</p>
    </header>
    ...
    <div class="game-player">
        <div class="game-container" id="gameContainer">
            ...
            <iframe
                ...
                loading="lazy"
                src="https://thespencergamingwebsite.com/clprecivilationbronzeage.html"
        ...
        <div class="game-details">
            <h2>🏛️ About Pre-Civilization Bronze Age</h2>
            <p>Pre-Civilization Bronze Age is an epic strategy game where you guide your tribe through the ages. Starting from humble beginnings in the stone age, you must manage resources, research technologies, and lead your people to prosperity in the bronze age.</p>

            <h3>⭐ Game Features</h3>
            <div class="features-grid">
                <div class="feature-item">
                    <strong>🏛️ Civilization Building</strong>
                    <p>Guide your tribe through the ages</p>
                </div>
                <div class="feature-item">
                    <strong>⚔️ Strategic Warfare</strong>
                    <p>Defend against enemies and expand territory</p>
                </div>
                <div class="feature-item">
                    <strong>🔬 Technology Tree</strong>
                    <p>Research advancements to unlock new abilities</p>
                </div>
                <div class="feature-item">
                    <strong>👥 Population Management</strong>
                    <p>Balance food, shelter, and growth</p>
                </div>
            </div>
            ...
            <div style="background: linear-gradient(135deg, rgba(255,255,255,0.1) 0%, rgba(78,205,196,0.1) 100%); padding: 20px; border-radius: 10px; border-left: 5px solid #FF6B6B; margin: 20px 0;">
                ...
                <ul>
                    ...
                    <li>Use menus to manage resources</li>
                    <li>Click map areas to expand</li>
                </ul>

                <p><strong>Mobile/Touch Controls:</strong></p>
                <ul>
                    <li>Tap to interact with menus and make selections</li>
                </ul>
            </div>

            <h3>💡 Gameplay Tips</h3>
            <ul style="color: #f8f9fa; font-size: 16px; font-weight: 500; line-height: 1.7; padding-left: 20px;">
                <li>Always keep food production ahead of population</li>
                <li>Research farming early for sustainable growth</li>
                <li>Build military before expanding too aggressively</li>
                <li>Balance between growth and defense</li>
                <li>Don't neglect happiness - unhappy people rebel</li>
            </ul>

            <h3>🏆 Objectives</h3>
            <ul style="color: #f8f9fa; font-size: 16px; font-weight: 500; line-height: 1.7; padding-left: 20px;">
                <li>Advance from stone age to bronze age</li>
                <li>Build a thriving civilization</li>
                <li>Defend against invaders</li>
            ...
            <div style="background: linear-gradient(135deg, rgba(255,107,107,0.2), rgba(78,205,196,0.2)); border: 2px solid #4ECDC4; border-radius: 10px; padding: 20px; margin-top: 25px; text-align: center;">
                ...
                <p style="color: #f8f9fa; font-weight: 500; margin: 0;">Food is the foundation of everything - without surplus food, your civilization cannot grow or research!</p>
            </div>
        </div>
    ...
    <div id="reportGameModal" style="display:none;position:fixed;inset:0;z-index:9999;background:rgba(0,0,0,0.8);align-items:center;justify-content:center;padding:20px;">
        <div style="background:linear-gradient(135deg,#0f172a,#1e293b);border:1px solid rgba(239,68,68,0.3);border-radius:14px;padding:28px;max-width:440px;width:100%;color:#e2e8f0;">
            ...
            <p style="color:#94a3b8;font-size:0.85rem;margin-bottom:14px;">Game: <strong>precivilationbronzeage</strong></p>
            ...
            <div style="display:flex;gap:8px;">
                <button onclick="submitGameReport('precivilationbronzeage')" style="flex:1;padding:10px;border:none;border-radius:8px;background:linear-gradient(135deg,#ef4444,#dc2626);color:#fff;font-weight:600;cursor:pointer;">Submit Report</button>
