...
<head>
    ...
    <meta name="description" content="Play Rooftop Snipers - Spencer's Game Collection">
    <title>Rooftop Snipers - Spencer's Website</title>
...
<header class="page-header">
        <h1>🎮 Rooftop Snipers <span class="game-badge">2-Player Game</span></h1>
        <p>Challenge your friends in this hilarious rooftop shooting game!</p>
    </header>

    <!-- Rooftop Snipers Game Player -->
    <div class="game-player">
        <div class="game-container" id="gameContainer">
            ...
            <iframe 
                ...
                loading="lazy"
                src="https://searchprox.global.ssl.fastly.net/public/assets/games/rooftop-snipers/" 
        ...
        <div class="game-details">
            <h2>🎯 About Rooftop Snipers</h2>
            <p>Rooftop Snipers is an addictive 2-player physics-based shooting game where you battle against a friend on precarious rooftops. Knock your opponent off the building using your sniper rifle's recoil! Perfect for quick gaming sessions with friends.</p>
            
            <h3>⭐ Game Features</h3>
            <div class="features-grid">
                <div class="feature-item">
                    <strong>🎯 2-Player Action</strong>
                    <p>Perfect for playing with a friend on the same device</p>
                </div>
                <div class="feature-item">
                    <strong>⚡ Physics-Based Gameplay</strong>
                    <p>Use recoil to knock opponents off buildings</p>
                </div>
                <div class="feature-item">
                    <strong>🏢 Multiple Rooftops</strong>
                    <p>Different levels with increasing difficulty</p>
                </div>
                <div class="feature-item">
                    <strong>🎮 Simple Controls</strong>
                    <p>Easy to learn, hard to master gameplay</p>
                </div>
                <div class="feature-item">
                    <strong>😂 Hilarious Action</strong>
                    <p>Funny characters and satisfying knockouts</p>
                </div>
                <div class="feature-item">
                    <strong>🏆 Competitive</strong>
                    <p>First to 5 wins - perfect for quick matches</p>
                </div>
            </div>
            ...
            <div style="background: linear-gradient(135deg, rgba(255,255,255,0.1) 0%, rgba(255,107,107,0.1) 100%); padding: 20px; border-radius: 10px; border-left: 5px solid #4ECDC4; margin: 20px 0;">
                <div class="control-scheme">
                    <div class="player-controls">
                        <h4 style="color: #FF6B6B; margin-bottom: 15px;">👤 Player 1 Controls</h4>
                        <ul style="color: #f8f9fa; font-size: 16px; font-weight: 500; line-height: 1.7; padding-left: 20px;">
                            ...
                            <li><strong>S</strong> - Duck/Crouch</li>
                            <li><strong>Spacebar</strong> - Shoot</li>
                        </ul>
                    </div>
                    
                    <div class="player-controls">
                        <h4 style="color: #4ECDC4; margin-bottom: 15px;">👤 Player 2 Controls</h4>
                        <ul style="color: #f8f9fa; font-size: 16px; font-weight: 500; line-height: 1.7; padding-left: 20px;">
                            <li><strong>← / →</strong> - Move left and right</li>
                            <li><strong>↑</strong> - Jump</li>
                            <li><strong>↓</strong> - Duck/Crouch</li>
                            <li><strong>Enter</strong> - Shoot</li>
                        </ul>
                    </div>
                </div>
                
                <p><strong>Game Objective:</strong> Be the first to score 5 points by knocking your opponent off the rooftop using your sniper rifle's recoil!</p>
            </div>

            <h3>💡 Gameplay Tips</h3>
            <ul style="color: #f8f9fa; font-size: 16px; font-weight: 500; line-height: 1.7; padding-left: 20px;">
                <li>Time your shots carefully - shooting at the wrong moment can knock YOU off instead!</li>
                <li>Use jumping to avoid enemy shots and position yourself better</li>
                <li>Crouching makes you a smaller target but limits your movement</li>
                <li>Try to shoot when your opponent is near the edge for maximum effect</li>
                <li>Watch the recoil pattern - it's consistent so you can learn to control it</li>
                <li>Don't just spam shots - strategic timing wins matches</li>
            </ul>

            <h3>🏆 Objectives & Strategies</h3>
            <ul style="color: #f8f9fa; font-size: 16px; font-weight: 500; line-height: 1.7; padding-left: 20px;">
                <li>First player to score 5 points wins the match</li>
                <li>Master the recoil pattern for precise movement</li>
                <li>Learn to predict your opponent's movements</li>
                <li>Use the environment to your advantage</li>
                <li>Practice different shooting angles</li>
                <li>Develop your own playing style</li>
            </ul>
            ...
            <div style="background: linear-gradient(135deg, rgba(255,107,107,0.2), rgba(78,205,196,0.2)); border: 2px solid #FF6B6B; border-radius: 10px; padding: 20px; margin-top: 25px; text-align: center;">
                ...
                <p style="color: #f8f9fa; font-weight: 500; margin: 0;">The key to winning is controlling your recoil! Shoot when you're firmly planted and your opponent is off-balance near the edge. Patience beats button-mashing every time!</p>
            </div>
        </div>
    </div>
    ...
    <div id="reportGameModal" style="display:none;position:fixed;inset:0;z-index:9999;background:rgba(0,0,0,0.8);align-items:center;justify-content:center;padding:20px;">
        <div style="background:linear-gradient(135deg,#0f172a,#1e293b);border:1px solid rgba(239,68,68,0.3);border-radius:14px;padding:28px;max-width:440px;width:100%;color:#e2e8f0;">
            ...
            <p style="color:#94a3b8;font-size:0.85rem;margin-bottom:14px;">Game: <strong>roof</strong></p>
            ...
            <div style="display:flex;gap:8px;">
                <button onclick="submitGameReport('roof')" style="flex:1;padding:10px;border:none;border-radius:8px;background:linear-gradient(135deg,#ef4444,#dc2626);color:#fff;font-weight:600;cursor:pointer;">Submit Report</button>
