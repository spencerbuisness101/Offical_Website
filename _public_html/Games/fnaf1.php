...
<head>
    ...
    <meta name="description" content="Play Five Nights Of Freddy's! - Spencer's Game Collection">
    <title>Five Nights Of Freddy's! - Spencer's Website</title>
...
<body data-backgrounds='<?php echo htmlspecialchars(json_encode($available_backgrounds), ENT_QUOTES, 'UTF-8'); ?>' 
    ...
    <header class="page-header">
        <h1>🕷️ About Five Nights at Freddy's <span class="game-badge">Survival Horror (RENEWED!)</span></h1>
        <p>Survive the night shift at Freddy Fazbear's Pizza in this tense survival horror experience!</p>
    </header>
    ...
    <div class="game-player">
        <div class="game-container" id="gameContainer">
            ...
            <iframe 
                ...
                loading="lazy"
                src="https://thespencergamingwebsite.com/clfnaf.html" 
...
<div class="game-details">
    <h2>🕷️ About Five Nights at Freddy's</h2>
    <p>Five Nights at Freddy's is a tense survival horror game where you work as a night security guard at Freddy Fazbear's Pizza. Survive from midnight to 6 AM by monitoring security cameras and using limited power to keep the animatronic characters at bay. Each night gets progressively more challenging as the animatronics become more active and aggressive!</p>
    
    <h3>⭐ Game Features</h3>
<div class="features-grid">
    <div class="feature-item">
        <strong>🎥 Security Monitoring</strong>
        <p>Watch the building through a network of security cameras to track animatronic movements</p>
    </div>
    <div class="feature-item">
        <strong>⚡ Power Management</strong>
        <p>Strategically use limited power for lights, doors, and cameras to survive the night</p>
    </div>
    <div class="feature-item">
        <strong>😱 Atmospheric Horror</strong>
        <p>Experience tension through sound cues, limited visibility, and jump scares</p>
    </div>
    <div class="feature-item">
        <strong>🌙 Progressive Difficulty</strong>
        <p>Survive five increasingly difficult nights as the animatronics become more aggressive</p>
    </div>
</div>
...
<div style="background: linear-gradient(135deg, rgba(255,255,255,0.1) 0%, rgba(78,205,196,0.1) 100%); padding: 20px; border-radius: 10px; border-left: 5px solid #FF6B6B; margin: 20px 0;">
    ...
    <ul>
        <li><strong>Mouse:</strong> Click on cameras to switch views and monitor animatronics</li>
        <li><strong>Doors:</strong> Click the door buttons to close/open left and right doors</li>
        <li><strong>Lights:</strong> Click light buttons to check hallways without using cameras</li>
        <li><strong>Monitor:</strong> Press the monitor button to view security cameras</li>
        <li>Game ends when you run out of power or get caught by an animatronic</li>
    </ul>
    
    <p><strong>Game Mechanics:</strong></p>
    <ul>
        <li><strong>Power Management:</strong> Every action drains limited power - use it wisely</li>
        <li><strong>Audio Cues:</strong> Listen for footsteps, music, and other signs of animatronic movement</li>
        <li><strong>Camera Strategy:</strong> Check cameras frequently to track animatronic positions</li>
    </ul>
</div>

<h3>💡 Survival Tips</h3>
<ul style="color: #f8f9fa; font-size: 16px; font-weight: 500; line-height: 1.7; padding-left: 20px;">
    <li>Conserve power - only use lights and doors when absolutely necessary</li>
    <li>Check the Show Stage camera (CAM 1B) frequently to monitor Freddy, Bonnie, and Chica</li>
    <li>Listen for audio cues like footsteps, banging, or distorted laughter</li>
    <li>Close doors only when you see or hear an animatronic nearby</li>
    <li>Watch Pirate's Cove (CAM 1C) - if Foxy leaves, be ready to close the left door</li>
</ul>

<h3>🏆 Objectives</h3>
<ul style="color: #f8f9fa; font-size: 16px; font-weight: 500; line-height: 1.7; padding-left: 20px;">
    <li>Survive from 12 AM to 6 AM each night</li>
    <li>Manage your power supply efficiently through the night</li>
    <li>Monitor animatronic movements using security cameras</li>
    <li>Complete all five nights of increasing difficulty</li>
    <li>Uncover the mysterious story of Freddy Fazbear's Pizza</li>
</ul>
...
<div style="background: linear-gradient(135deg, rgba(255,107,107,0.2), rgba(78,205,196,0.2)); border: 2px solid #4ECDC4; border-radius: 10px; padding: 20px; margin-top: 25px; text-align: center;">
    ...
    <p style="color: #f8f9fa; font-weight: 500; margin: 0;">If you hear heavy breathing or see a distorted face on your camera, immediately put down the monitor and close the door on that side - it's already in your office!</p>
</div>
    ...
    <div id="reportGameModal" style="display:none;position:fixed;inset:0;z-index:9999;background:rgba(0,0,0,0.8);align-items:center;justify-content:center;padding:20px;">
        <div style="background:linear-gradient(135deg,#0f172a,#1e293b);border:1px solid rgba(239,68,68,0.3);border-radius:14px;padding:28px;max-width:440px;width:100%;color:#e2e8f0;">
            ...
            <p style="color:#94a3b8;font-size:0.85rem;margin-bottom:14px;">Game: <strong>fnaf1</strong></p>
            ...
            <div style="display:flex;gap:8px;">
                <button onclick="submitGameReport('fnaf1')" style="flex:1;padding:10px;border:none;border-radius:8px;background:linear-gradient(135deg,#ef4444,#dc2626);color:#fff;font-weight:600;cursor:pointer;">Submit Report</button>
