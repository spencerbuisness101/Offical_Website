...
<head>
    ...
    <meta name="description" content="Baldi's Basics - Spencer's Game Collection">
    <title>Baldi's Basics - Spencer's Website</title>
...
<body data-backgrounds='<?php echo htmlspecialchars(json_encode($available_backgrounds), ENT_QUOTES, 'UTF-8'); ?>'
    ...
    <header class="page-header">
        <h1>📚 Baldi's Basics <span class="game-badge">Horror/Education</span></h1>
        <p>Learn math or face the consequences!</p>
    </header>
    ...
    <div class="game-player">
        <div class="game-container" id="gameContainer">
            ...
            <iframe
                ...
                loading="lazy"
                src="https://thespencergamingwebsite.com/clbaldisbasics.html"
        ...
        <div class="game-details">
            <h2>📚 About Baldi's Basics</h2>
            <p>Baldi's Basics is a unique indie horror game that parodies 90s educational games. Navigate through a creepy school, solve math problems, collect notebooks, and try to escape before Baldi catches you. But beware - not all problems have correct answers!</p>

            <h3>⭐ Game Features</h3>
            <div class="features-grid">
                <div class="feature-item">
                    <strong>📚 Educational Horror</strong>
                    <p>A unique blend of learning and terror</p>
                </div>
                <div class="feature-item">
                    <strong>😱 Escape the School</strong>
                    <p>Navigate through hallways while avoiding Baldi</p>
                </div>
                <div class="feature-item">
                    <strong>🎒 Collect Notebooks</strong>
                    <p>Find all 7 notebooks to escape</p>
                </div>
                <div class="feature-item">
                    <strong>👤 Quirky Characters</strong>
                    <p>Principal, Playtime, and more stand in your way</p>
                </div>
            </div>
            ...
            <div style="background: linear-gradient(135deg, rgba(255,255,255,0.1) 0%, rgba(78,205,196,0.1) 100%); padding: 20px; border-radius: 10px; border-left: 5px solid #FF6B6B; margin: 20px 0;">
                ...
                <ul>
                    ...
                    <li>Left click to interact/use items</li>
                    <li>Space to run (drains stamina)</li>
                </ul>

                <p><strong>Mobile/Touch Controls:</strong></p>
                <ul>
                    <li>Virtual joystick</li>
                    <li>Tap to interact with objects</li>
                </ul>
            </div>

            <h3>💡 Gameplay Tips</h3>
            <ul style="color: #f8f9fa; font-size: 16px; font-weight: 500; line-height: 1.7; padding-left: 20px;">
                <li>Always keep moving - standing still lets Baldi catch up</li>
                <li>Use items like BSoda to push characters away</li>
                <li>Listen for Baldi's ruler slaps to gauge his distance</li>
                <li>Hide in closets when Baldi is too close</li>
                <li>Learn the school layout to plan escape routes</li>
            </ul>

            <h3>🏆 Objectives</h3>
            <ul style="color: #f8f9fa; font-size: 16px; font-weight: 500; line-height: 1.7; padding-left: 20px;">
                <li>Find and collect all 7 notebooks</li>
                <li>Solve math problems (some are impossible!)</li>
                <li>Escape through the exits</li>
                <li>Avoid Baldi and other characters</li>
                <li>Use items strategically to survive</li>
            </ul>
            ...
            <div style="background: linear-gradient(135deg, rgba(255,107,107,0.2), rgba(78,205,196,0.2)); border: 2px solid #4ECDC4; border-radius: 10px; padding: 20px; margin-top: 25px; text-align: center;">
                ...
                <p style="color: #f8f9fa; font-weight: 500; margin: 0;">You can't solve all the math problems correctly - it's designed that way! Focus on escaping, not perfection!</p>
            </div>
        </div>
    ...
    <div id="reportGameModal" style="display:none;position:fixed;inset:0;z-index:9999;background:rgba(0,0,0,0.8);align-items:center;justify-content:center;padding:20px;">
        <div style="background:linear-gradient(135deg,#0f172a,#1e293b);border:1px solid rgba(239,68,68,0.3);border-radius:14px;padding:28px;max-width:440px;width:100%;color:#e2e8f0;">
            ...
            <p style="color:#94a3b8;font-size:0.85rem;margin-bottom:14px;">Game: <strong>baldisbasics</strong></p>
            ...
            <div style="display:flex;gap:8px;">
                <button onclick="submitGameReport('baldisbasics')" style="flex:1;padding:10px;border:none;border-radius:8px;background:linear-gradient(135deg,#ef4444,#dc2626);color:#fff;font-weight:600;cursor:pointer;">Submit Report</button>
