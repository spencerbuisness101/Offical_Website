...
<head>
    ...
    <meta name="description" content="Play Slope - Spencer's Game Collection">
    <title>Slope - Spencer's Website</title>
...
<div class="container">
    ...
    <header class="page-header">
        <h1>🎮 Slope <span class="game-badge">3D Runner</span></h1>
        <p>Race down the neon slopes at breakneck speed in this addictive 3D running game!</p>
    </header>
    ...
    <div class="game-player">
        <div class="game-container" id="gameContainer">
            ...
            <iframe 
                ...
                loading="lazy"
                src="https://searchprox.global.ssl.fastly.net/public/assets/games/slope/" 
        ...
        <div class="game-details">
            <h2>🎯 About Slope</h2>
            <p>Slope is an exciting 3D running game where you control a ball racing down a neon slope at high speed. Navigate through challenging obstacles, make sharp turns, and try to survive as long as possible while achieving the highest score!</p>
            
            <h3>⭐ Game Features</h3>
            <div class="features-grid">
                <div class="feature-item">
                    <strong>🚀 High-Speed Action</strong>
                    <p>Experience thrilling speed as you race down endless slopes</p>
                </div>
                <div class="feature-item">
                    <strong>🎨 Neon Graphics</strong>
                    <p>Vibrant neon visuals with smooth 3D rendering</p>
                </div>
                <div class="feature-item">
                    <strong>🎯 Precision Controls</strong>
                    <p>Simple but challenging controls that test your reflexes</p>
                </div>
                <div class="feature-item">
                    <strong>🏆 Endless Challenge</strong>
                    <p>Procedurally generated courses for unlimited replayability</p>
                </div>
            </div>
            ...
            <div style="background: linear-gradient(135deg, rgba(255,255,255,0.1) 0%, rgba(255,107,107,0.1) 100%); padding: 20px; border-radius: 10px; border-left: 5px solid #4ECDC4; margin: 20px 0;">
                ...
                <ul>
                    <li><strong>A / Left Arrow</strong> - Move ball to the left</li>
                    <li><strong>D / Right Arrow</strong> - Move ball to the right</li>
                    <li>Navigate through <strong>obstacles and gaps</strong></li>
                    <li>Maintain <strong>balance and control</strong> at high speeds</li>
                </ul>
                
                <p><strong>Mobile/Touch Controls:</strong></p>
                <ul>
                    <li><strong>Swipe Left</strong> - Move ball to the left</li>
                    <li><strong>Swipe Right</strong> - Move ball to the right</li>
                    <li>Tilt controls for precise movement</li>
                    <li>Simple and responsive touch interface</li>
                </ul>
            </div>

            <h3>💡 Gameplay Tips</h3>
            <ul style="color: #f8f9fa; font-size: 16px; font-weight: 500; line-height: 1.7; padding-left: 20px;">
                <li>Focus on the <strong>upcoming obstacles</strong> rather than your immediate position</li>
                <li>Make <strong>small, precise movements</strong> rather than large swerves</li>
                <li>Build up <strong>speed gradually</strong> - don't rush too fast at the beginning</li>
                <li>Watch for <strong>color patterns</strong> that indicate upcoming challenges</li>
                <li>Practice <strong>rhythmic timing</strong> for obstacle navigation</li>
            </ul>

            <h3>🏆 Objectives</h3>
            <ul style="color: #f8f9fa; font-size: 16px; font-weight: 500; line-height: 1.7; padding-left: 20px;">
                <li>Survive as long as possible on the slope</li>
                <li>Achieve the highest score by covering maximum distance</li>
                <li>Navigate through increasingly difficult obstacles</li>
                <li>Master the controls for precise movement</li>
                <li>Beat your personal best and compete for high scores</li>
            </ul>
            ...
            <div style="background: linear-gradient(135deg, rgba(255,107,107,0.2), rgba(78,205,196,0.2)); border: 2px solid #FF6B6B; border-radius: 10px; padding: 20px; margin-top: 25px; text-align: center;">
                ...
                <p style="color: #f8f9fa; font-weight: 500; margin: 0;">The key to high scores in Slope is maintaining a steady rhythm and anticipating obstacles well in advance. Don't panic when the speed increases - stay calm and focused!</p>
            </div>
        </div>
    </div>
    ...
    <div id="reportGameModal" style="display:none;position:fixed;inset:0;z-index:9999;background:rgba(0,0,0,0.8);align-items:center;justify-content:center;padding:20px;">
        <div style="background:linear-gradient(135deg,#0f172a,#1e293b);border:1px solid rgba(239,68,68,0.3);border-radius:14px;padding:28px;max-width:440px;width:100%;color:#e2e8f0;">
            ...
            <p style="color:#94a3b8;font-size:0.85rem;margin-bottom:14px;">Game: <strong>slope</strong></p>
            ...
            <div style="display:flex;gap:8px;">
                <button onclick="submitGameReport('slope')" style="flex:1;padding:10px;border:none;border-radius:8px;background:linear-gradient(135deg,#ef4444,#dc2626);color:#fff;font-weight:600;cursor:pointer;">Submit Report</button>
