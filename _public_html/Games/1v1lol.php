...
<head>
    ...
    <meta name="description" content="Play 1v1.LOL - Spencer's Game Collection">
    <title>1v1.LOL - Spencer's Website</title>
...
<div class="container">
    ...
    <header class="page-header">
        <h1>🎮 1v1.LOL <span class="game-badge">Action/Shooter</span></h1>
        <p>Build, shoot, and dominate in this fast-paced competitive 1v1 battle arena!</p>
    </header>
    ...
    <div class="game-player">
        <div class="game-container" id="gameContainer">
            ...
            <iframe
                ...
                loading="lazy"
                src="https://c.voidnetwork.space.cdn.cloudflare.net/onlylocal/html/58.html"
        ...
        <div class="game-details">
            <h2>🎯 About 1v1.LOL</h2>
            <p>1v1.LOL is a competitive online building and shooting game. Build structures, take cover, and eliminate opponents in fast-paced 1v1 battles. Combine quick building skills with precise aim to outplay your opponents in this intense multiplayer experience.</p>

            <h3>⭐ Game Features</h3>
            <div class="features-grid">
                <div class="feature-item">
                    <strong>🏗️ Build & Fight</strong>
                    <p>Construct walls, ramps, and floors while battling opponents</p>
                </div>
                <div class="feature-item">
                    <strong>🔫 Competitive Shooting</strong>
                    <p>Test your aim in intense 1v1 combat scenarios</p>
                </div>
                <div class="feature-item">
                    <strong>🎯 Multiple Modes</strong>
                    <p>Play 1v1, Battle Royale, Box Fight, and more game modes</p>
                </div>
                <div class="feature-item">
                    <strong>🏆 Skill-Based</strong>
                    <p>Improve your building and shooting mechanics to climb ranks</p>
                </div>
            </div>
            ...
            <div style="background: linear-gradient(135deg, rgba(255,255,255,0.1) 0%, rgba(255,107,107,0.1) 100%); padding: 20px; border-radius: 10px; border-left: 5px solid #4ECDC4; margin: 20px 0;">
                ...
                <p><strong>Combat & Building Controls:</strong></p>
                <ul>
                    <li><strong>Mouse</strong> - Aim and shoot</li>
                    <li><strong>Left Click</strong> - Fire weapon / Place build</li>
                    <li><strong>Build walls, ramps, and floors</strong> to gain tactical advantage</li>
                    <li>Switch between <strong>combat and build mode</strong> quickly</li>
                </ul>
            </div>

            <h3>💡 Gameplay Tips</h3>
            <ul style="color: #f8f9fa; font-size: 16px; font-weight: 500; line-height: 1.7; padding-left: 20px;">
                <li>Practice <strong>building quickly</strong> - speed is key in build battles</li>
                <li>Always <strong>take high ground</strong> when possible for a tactical advantage</li>
                <li>Learn to <strong>edit builds</strong> for surprise attacks on opponents</li>
                <li>Use <strong>ramps for cover</strong> while pushing toward enemies</li>
                <li>Master <strong>quick weapon swaps</strong> for maximum damage output</li>
            </ul>

            <h3>🏆 Objectives</h3>
            <ul style="color: #f8f9fa; font-size: 16px; font-weight: 500; line-height: 1.7; padding-left: 20px;">
                <li>Eliminate your opponent in 1v1 battles</li>
                <li>Build structures for defense and offense</li>
                <li>Master different weapon types and strategies</li>
                <li>Climb the ranks and improve your skills</li>
                <li>Win matches across various game modes</li>
            </ul>
            ...
            <div style="background: linear-gradient(135deg, rgba(255,107,107,0.2), rgba(78,205,196,0.2)); border: 2px solid #FF6B6B; border-radius: 10px; padding: 20px; margin-top: 25px; text-align: center;">
                ...
                <p style="color: #f8f9fa; font-weight: 500; margin: 0;">The best players combine building and shooting seamlessly. Practice building ramps and walls while maintaining aim on your target. Speed and accuracy together will make you unstoppable!</p>
            </div>
        </div>
    </div>
    ...
    <div id="reportGameModal" style="display:none;position:fixed;inset:0;z-index:9999;background:rgba(0,0,0,0.8);align-items:center;justify-content:center;padding:20px;">
        <div style="background:linear-gradient(135deg,#0f172a,#1e293b);border:1px solid rgba(239,68,68,0.3);border-radius:14px;padding:28px;max-width:440px;width:100%;color:#e2e8f0;">
            ...
            <p style="color:#94a3b8;font-size:0.85rem;margin-bottom:14px;">Game: <strong>1v1lol</strong></p>
            ...
            <div style="display:flex;gap:8px;">
                <button onclick="submitGameReport('1v1lol')" style="flex:1;padding:10px;border:none;border-radius:8px;background:linear-gradient(135deg,#ef4444,#dc2626);color:#fff;font-weight:600;cursor:pointer;">Submit Report</button>
