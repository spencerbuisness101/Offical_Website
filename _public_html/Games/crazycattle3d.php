...
<head>
    ...
    <meta name="description" content="Crazy Cattle 3D - Spencer's Game Collection">
    <title>Crazy Cattle 3D - Spencer's Website</title>
...
<body data-backgrounds='<?php echo htmlspecialchars(json_encode($available_backgrounds), ENT_QUOTES, 'UTF-8'); ?>'
    ...
    <header class="page-header">
        <h1>Crazy Cattle 3D <span class="game-badge">Action</span></h1>
        <p>Wild cattle action in stunning 3D!</p>
    </header>
    ...
    <div class="game-player">
        <div class="game-container" id="gameContainer">
            ...
            <iframe
                ...
                loading="lazy"
                src="https://thespencergamingwebsite.com/clcrazycattle3d.html"
        ...
        <div class="game-details">
            ...
            <p>Crazy Cattle 3D is an action-packed 3D game where you control wild cattle in chaotic and hilarious scenarios. Run, jump, and cause mayhem in this entertaining 3D adventure!</p>

            <h3>Game Features</h3>
            <div class="features-grid">
                <div class="feature-item">
                    <strong>3D Graphics</strong>
                    <p>Stunning 3D visuals with smooth animations</p>
                </div>
                <div class="feature-item">
                    <strong>Wild Gameplay</strong>
                    <p>Chaotic and fun cattle action</p>
                </div>
                <div class="feature-item">
                    <strong>Multiple Levels</strong>
                    <p>Various stages to conquer</p>
                </div>
                <div class="feature-item">
                    <strong>Physics Fun</strong>
                    <p>Hilarious physics-based interactions</p>
                </div>
            </div>
            ...
            <div style="background: linear-gradient(135deg, rgba(255,255,255,0.1) 0%, rgba(78,205,196,0.1) 100%); padding: 20px; border-radius: 10px; border-left: 5px solid #FF6B6B; margin: 20px 0;">
                ...
                <ul>
                    ...
                    <li>Space to jump</li>
                    <li>Mouse to control camera</li>
                    <li>Left Click for special actions</li>
                </ul>
            </div>

            <h3>Gameplay Tips</h3>
            <ul style="color: #f8f9fa; font-size: 16px; font-weight: 500; line-height: 1.7; padding-left: 20px;">
                <li>Build up momentum for bigger impacts</li>
                <li>Use jumps to reach higher areas</li>
                <li>Explore every corner of the map</li>
                <li>Chain actions together for combos</li>
            </ul>

            <h3>Objectives</h3>
            <ul style="color: #f8f9fa; font-size: 16px; font-weight: 500; line-height: 1.7; padding-left: 20px;">
                <li>Complete all levels</li>
                <li>Cause maximum chaos</li>
                <li>Collect bonus items</li>
            ...
            <div style="background: linear-gradient(135deg, rgba(255,107,107,0.2), rgba(78,205,196,0.2)); border: 2px solid #4ECDC4; border-radius: 10px; padding: 20px; margin-top: 25px; text-align: center;">
                ...
                <p style="color: #f8f9fa; font-weight: 500; margin: 0;">The faster you run, the more damage you can cause when you collide with objects!</p>
            </div>
        </div>
    ...
    <div id="reportGameModal" style="display:none;position:fixed;inset:0;z-index:9999;background:rgba(0,0,0,0.8);align-items:center;justify-content:center;padding:20px;">
        <div style="background:linear-gradient(135deg,#0f172a,#1e293b);border:1px solid rgba(239,68,68,0.3);border-radius:14px;padding:28px;max-width:440px;width:100%;color:#e2e8f0;">
            ...
            <p style="color:#94a3b8;font-size:0.85rem;margin-bottom:14px;">Game: <strong>crazycattle3d</strong></p>
            ...
            <div style="display:flex;gap:8px;">
                <button onclick="submitGameReport('crazycattle3d')" style="flex:1;padding:10px;border:none;border-radius:8px;background:linear-gradient(135deg,#ef4444,#dc2626);color:#fff;font-weight:600;cursor:pointer;">Submit Report</button>
