...
<head>
    ...
    <meta name="description" content="Funny Battle 2 - Spencer's Game Collection">
    <title>Funny Battle 2 - Spencer's Website</title>
...
<body data-backgrounds='<?php echo htmlspecialchars(json_encode($available_backgrounds), ENT_QUOTES, 'UTF-8'); ?>'
    ...
    <header class="page-header">
        <h1>⚔️ Funny Battle 2 <span class="game-badge">Action</span></h1>
        <p>Hilarious stick figure combat!</p>
    </header>
    ...
    <div class="game-player">
        <div class="game-container" id="gameContainer">
            ...
            <iframe
                ...
                loading="lazy"
                src="https://thespencergamingwebsite.com/clfunnybattle2.html"
        ...
        <div class="game-details">
            <h2>⚔️ About Funny Battle 2</h2>
            <p>Funny Battle 2 is an action-packed stick figure fighting game that delivers hilarious combat and intense battles. Jump into fast-paced fighting action with various game modes, special moves, and competitive gameplay that will keep you entertained for hours.</p>

            <h3>⭐ Game Features</h3>
            <div class="features-grid">
                <div class="feature-item">
                    <strong>⚔️ Epic Combat</strong>
                    <p>Fast-paced stick figure fighting action</p>
                </div>
                <div class="feature-item">
                    <strong>🎭 Multiple Modes</strong>
                    <p>Various game modes to keep things fresh</p>
                </div>
                <div class="feature-item">
                    <strong>💪 Special Moves</strong>
                    <p>Unlock and use powerful abilities</p>
                </div>
                <div class="feature-item">
                    <strong>🏆 Competitive Play</strong>
                    <p>Fight to become the ultimate champion</p>
                </div>
            </div>
            ...
            <div style="background: linear-gradient(135deg, rgba(255,255,255,0.1) 0%, rgba(78,205,196,0.1) 100%); padding: 20px; border-radius: 10px; border-left: 5px solid #FF6B6B; margin: 20px 0;">
                ...
                <ul>
                    ...
                    <li>Z/X or J/K to attack</li>
                    <li>Spacebar for special moves</li>
                </ul>

                <p><strong>Mobile/Touch Controls:</strong></p>
                <ul>
                    <li>On-screen joystick and buttons for combat</li>
                </ul>
            </div>

            <h3>💡 Gameplay Tips</h3>
            <ul style="color: #f8f9fa; font-size: 16px; font-weight: 500; line-height: 1.7; padding-left: 20px;">
                <li>Learn the timing of your attacks for combos</li>
                <li>Block and dodge to avoid enemy hits</li>
                <li>Use special moves at the right moment</li>
                <li>Watch enemy patterns and counter</li>
                <li>Practice different characters to find your style</li>
            </ul>

            <h3>🏆 Objectives</h3>
            <ul style="color: #f8f9fa; font-size: 16px; font-weight: 500; line-height: 1.7; padding-left: 20px;">
                <li>Defeat all opponents in battle</li>
                <li>Master different fighting styles</li>
                <li>Unlock new characters and abilities</li>
                <li>Complete all game modes</li>
                <li>Become the ultimate stick fighter</li>
            </ul>
            ...
            <div style="background: linear-gradient(135deg, rgba(255,107,107,0.2), rgba(78,205,196,0.2)); border: 2px solid #4ECDC4; border-radius: 10px; padding: 20px; margin-top: 25px; text-align: center;">
                ...
                <p style="color: #f8f9fa; font-weight: 500; margin: 0;">Timing is everything - a well-timed dodge followed by a counterattack is devastating!</p>
            </div>
        </div>
    ...
    <div id="reportGameModal" style="display:none;position:fixed;inset:0;z-index:9999;background:rgba(0,0,0,0.8);align-items:center;justify-content:center;padding:20px;">
        <div style="background:linear-gradient(135deg,#0f172a,#1e293b);border:1px solid rgba(239,68,68,0.3);border-radius:14px;padding:28px;max-width:440px;width:100%;color:#e2e8f0;">
            ...
            <p style="color:#94a3b8;font-size:0.85rem;margin-bottom:14px;">Game: <strong>funnybattle</strong></p>
            ...
            <div style="display:flex;gap:8px;">
                <button onclick="submitGameReport('funnybattle')" style="flex:1;padding:10px;border:none;border-radius:8px;background:linear-gradient(135deg,#ef4444,#dc2626);color:#fff;font-weight:600;cursor:pointer;">Submit Report</button>
