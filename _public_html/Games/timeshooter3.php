...
<head>
    ...
    <meta name="description" content="Play Time Shooter 3: SWAT - Spencer's Game Collection">
    <title>Time Shooter 3: SWAT - Spencer's Website</title>
...
<div class="container">
    ...
    <header class="page-header">
        <h1>🎮 Time Shooter 3: SWAT <span class="game-badge">Action/Tactical</span></h1>
        <p>Time-bending SWAT missions! Breach doors, clear rooms, and use tactical gear with precision.</p>
    </header>

    <!-- Time Shooter 3 Game Player -->
    <div class="game-player">
        <div class="game-container" id="gameContainer">
            ...
            <iframe
                ...
                loading="lazy"
                src="https://thespencergamingwebsite.com/cltimeshooter3.html"
        ...
        <div class="game-details">
            <h2>🎯 About Time Shooter 3: SWAT</h2>
            <p>Time Shooter 3: SWAT takes the time-bending mechanic to the next level with SWAT-themed missions. Use tactical gear, breach doors, and clear rooms with precision. Time still only moves when you do, but now you have access to shields, new weapons, and tactical equipment.</p>

            <h3>⭐ Game Features</h3>
            <div class="features-grid">
                <div class="feature-item">
                    <strong>🛡️ SWAT Tactical Gear</strong>
                    <p>Use shields, breach charges, and tactical equipment in missions</p>
                </div>
                <div class="feature-item">
                    <strong>⏰ Time-Freeze Mechanic</strong>
                    <p>Time only moves when you move - plan each step carefully</p>
                </div>
                <div class="feature-item">
                    <strong>🚪 Door Breaching</strong>
                    <p>Breach doors and clear rooms like a real SWAT operator</p>
                </div>
                <div class="feature-item">
                    <strong>🔫 New Weapons Arsenal</strong>
                    <p>Access shotguns, SMGs, shields, and more tactical weapons</p>
                </div>
            </div>
            ...
            <div style="background: linear-gradient(135deg, rgba(255,255,255,0.1) 0%, rgba(255,107,107,0.1) 100%); padding: 20px; border-radius: 10px; border-left: 5px solid #4ECDC4; margin: 20px 0;">
                <p><strong>Movement & Combat Controls:</strong></p>
                <ul>
                    <li><strong>WASD</strong> - Move your character (time moves with you!)</li>
                    <li><strong>Mouse</strong> - Aim at enemies</li>
                    <li><strong>Left Click</strong> - Shoot / Use weapon</li>
                    <li><strong>E</strong> - Pick up weapons and equipment</li>
                    <li><strong>Time moves when you move</strong> - stand still to freeze time</li>
                </ul>

                <p><strong>Tactical Tips:</strong></p>
                <ul>
                    <li>Use <strong>shields</strong> to block incoming bullets while advancing</li>
                    <li><strong>Breach doors</strong> strategically to surprise enemies inside</li>
                    <li>Pick up <strong>fallen enemy weapons</strong> when you run low on ammo</li>
                    <li>Use the <strong>time-freeze</strong> to scout rooms before entering</li>
                </ul>
            </div>

            <h3>💡 Gameplay Tips</h3>
            <ul style="color: #f8f9fa; font-size: 16px; font-weight: 500; line-height: 1.7; padding-left: 20px;">
                <li>Always <strong>grab a shield</strong> when available - it can save your life</li>
                <li>Use <strong>small movements</strong> to peek around corners and scout enemies</li>
                <li>Prioritize enemies with <strong>automatic weapons</strong> as they are the most dangerous</li>
                <li><strong>Breach and clear</strong> rooms systematically rather than rushing in</li>
                <li>Remember you can <strong>throw weapons</strong> at enemies as a last resort</li>
            </ul>

            <h3>🏆 Objectives</h3>
            <ul style="color: #f8f9fa; font-size: 16px; font-weight: 500; line-height: 1.7; padding-left: 20px;">
                <li>Clear all enemies in each SWAT mission</li>
                <li>Use tactical equipment effectively to complete objectives</li>
                <li>Progress through increasingly complex room layouts</li>
                <li>Master the combination of time control and tactical gameplay</li>
                <li>Complete all missions with the highest rating possible</li>
            </ul>
            ...
            <div style="background: linear-gradient(135deg, rgba(255,107,107,0.2), rgba(78,205,196,0.2)); border: 2px solid #FF6B6B; border-radius: 10px; padding: 20px; margin-top: 25px; text-align: center;">
                ...
                <p style="color: #f8f9fa; font-weight: 500; margin: 0;">The shield is your best friend in Time Shooter 3. Hold it up while moving to block bullets, then quickly switch to your weapon to take out enemies. Combining the shield with the time-freeze mechanic makes you nearly unstoppable!</p>
            </div>
        </div>
    </div>
    ...
    <div id="reportGameModal" style="display:none;position:fixed;inset:0;z-index:9999;background:rgba(0,0,0,0.8);align-items:center;justify-content:center;padding:20px;">
        <div style="background:linear-gradient(135deg,#0f172a,#1e293b);border:1px solid rgba(239,68,68,0.3);border-radius:14px;padding:28px;max-width:440px;width:100%;color:#e2e8f0;">
            ...
            <p style="color:#94a3b8;font-size:0.85rem;margin-bottom:14px;">Game: <strong>timeshooter3</strong></p>
            ...
            <div style="display:flex;gap:8px;">
                <button onclick="submitGameReport('timeshooter3')" style="flex:1;padding:10px;border:none;border-radius:8px;background:linear-gradient(135deg,#ef4444,#dc2626);color:#fff;font-weight:600;cursor:pointer;">Submit Report</button>
