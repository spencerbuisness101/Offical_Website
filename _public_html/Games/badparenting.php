...
<head>
    ...
    <meta name="description" content="Bad Parenting - Spencer's Game Collection">
    <title>Bad Parenting - Spencer's Website</title>
...
<body data-backgrounds='<?php echo htmlspecialchars(json_encode($available_backgrounds), ENT_QUOTES, 'UTF-8'); ?>'
    ...
    <header class="page-header">
        <h1>Bad Parenting <span class="game-badge">Horror</span></h1>
        <p>A chilling horror experience with dark themes (WAIT 10-20 SECONDS FOR IT TO LOAD!!!!!)</p>
    </header>
    ...
    <div class="game-player">
        <div class="game-container" id="gameContainer">
            ...
            <iframe
                ...
                loading="lazy"
                src="https://c.voidnetwork.space.cdn.cloudflare.net/onlylocal/html/166.html"
        ...
        <div class="game-details">
            <h2>About Bad Parenting</h2>
            <p>Bad Parenting is an atmospheric horror game that explores dark and unsettling themes. Navigate through a haunting environment filled with tension and psychological horror elements.</p>

            <h3>Game Features</h3>
            <div class="features-grid">
                <div class="feature-item">
                    <strong>Atmospheric Horror</strong>
                    <p>Immersive dark atmosphere with chilling visuals</p>
                </div>
                <div class="feature-item">
                    <strong>Psychological Tension</strong>
                    <p>Suspenseful gameplay that keeps you on edge</p>
                </div>
                <div class="feature-item">
                    <strong>Exploration</strong>
                    <p>Discover hidden secrets and uncover the story</p>
                </div>
                <div class="feature-item">
                    <strong>Unique Story</strong>
                    <p>Experience a narrative-driven horror adventure</p>
                </div>
            </div>
            ...
            <div style="background: linear-gradient(135deg, rgba(255,255,255,0.1) 0%, rgba(78,205,196,0.1) 100%); padding: 20px; border-radius: 10px; border-left: 5px solid #FF6B6B; margin: 20px 0;">
                ...
                <ul>
                    ...
                    <li>Mouse to look around and interact</li>
                    <li>E or Left Click to interact with objects</li>
            ...
            <ul style="color: #f8f9fa; font-size: 16px; font-weight: 500; line-height: 1.7; padding-left: 20px;">
                ...
                <li>Listen carefully for audio cues</li>
                <li>Explore every room thoroughly</li>
                <li>Be prepared for jump scares</li>
                <li>Use headphones for the best experience</li>
            </ul>

            <h3>Objectives</h3>
            <ul style="color: #f8f9fa; font-size: 16px; font-weight: 500; line-height: 1.7; padding-left: 20px;">
                <li>Survive the horror experience</li>
                <li>Uncover the dark story</li>
                <li>Find clues and solve puzzles</li>
                <li>Escape the nightmare</li>
            </ul>
            ...
            <div style="background: linear-gradient(135deg, rgba(255,107,107,0.2), rgba(78,205,196,0.2)); border: 2px solid #4ECDC4; border-radius: 10px; padding: 20px; margin-top: 25px; text-align: center;">
                ...
                <p style="color: #f8f9fa; font-weight: 500; margin: 0;">This game contains horror elements. Player discretion is advised!</p>
            </div>
        </div>
    ...
    <div id="reportGameModal" style="display:none;position:fixed;inset:0;z-index:9999;background:rgba(0,0,0,0.8);align-items:center;justify-content:center;padding:20px;">
        <div style="background:linear-gradient(135deg,#0f172a,#1e293b);border:1px solid rgba(239,68,68,0.3);border-radius:14px;padding:28px;max-width:440px;width:100%;color:#e2e8f0;">
            ...
            <p style="color:#94a3b8;font-size:0.85rem;margin-bottom:14px;">Game: <strong>badparenting</strong></p>
            ...
            <div style="display:flex;gap:8px;">
                <button onclick="submitGameReport('badparenting')" style="flex:1;padding:10px;border:none;border-radius:8px;background:linear-gradient(135deg,#ef4444,#dc2626);color:#fff;font-weight:600;cursor:pointer;">Submit Report</button>
