...
<head>
    ...
    <meta name="description" content="Play Idle Breakout - Spencer's Game Collection">
    <title>Idle Breakout - Spencer's Website</title>
...
<body data-backgrounds='<?php echo htmlspecialchars(json_encode($available_backgrounds), ENT_QUOTES, 'UTF-8'); ?>'
    ...
    <header class="page-header">
        <h1>🧱⚾ Idle Breakout <span class="game-badge">Idle Clicker</span></h1>
        <p>Smash bricks, upgrade balls, and build the ultimate idle brick-breaking machine!</p>
    </header>

    <!-- Idle Breakout Game Player -->
    <div class="game-player">
        <div class="game-container" id="gameContainer">
            ...
            <iframe
                ...
                loading="lazy"
                src="https://c.voidnetwork.space.cdn.cloudflare.net/reading/L2RvY3VtZW50cy9pZGxlLWJyZWFrb3V0LXdlYi9jb250ZW50Lmh0bWw"
        ...
        <div class="game-details">
            <h2>🧱⚾ About Idle Breakout</h2>
            <p>Idle Breakout is a clicker idle game created by Kodiqi that puts a modern twist on the classic Atari Breakout arcade game. Combine retro brick-smashing action with addictive incremental mechanics! Start by clicking bricks to earn cash, then spend your earnings on an arsenal of unique balls that automatically bounce around and destroy bricks for you. Upgrade your balls, unlock power-ups, defeat bosses, and prestige your way to millions of broken bricks!</p>

            <h3>⭐ Game Features</h3>
            <div class="features-grid">
                <div class="feature-item">
                    <strong>🖱️ Click &amp; Idle Gameplay</strong>
                    <p>Click bricks manually or let your upgraded balls do the work automatically</p>
                </div>
                <div class="feature-item">
                    <strong>⚾ 6 Unique Ball Types</strong>
                    <p>Basic, Plasma, Sniper, Scatter, Cannon, and Poison balls</p>
                </div>
                <div class="feature-item">
                    <strong>👹 Boss Fights</strong>
                    <p>Face tough boss bricks every few levels for Skill Points and rewards</p>
                </div>
                <div class="feature-item">
                    <strong>🔄 Prestige System</strong>
                    <p>Reset for permanent bonuses and climb even higher next time</p>
                </div>
            </div>
            ...
            <div style="background: linear-gradient(135deg, rgba(255,255,255,0.1) 0%, rgba(0,191,255,0.1) 100%); padding: 20px; border-radius: 10px; border-left: 5px solid #00BFFF; margin: 20px 0;">
                ...
                <ul>
                    <li><strong>Left Click</strong> on bricks to manually break them and earn cash</li>
                    <li><strong>Click Buttons</strong> in the shop to purchase balls, upgrades, and power-ups</li>
                    <li>Use the <strong>menu tabs</strong> to navigate between Balls, Upgrades, Power-Ups, and Prestige</li>
                    <li>The game is entirely <strong>mouse-driven</strong> — no keyboard required!</li>
                </ul>

                <p><strong>Mobile/Touch Controls:</strong></p>
                <ul>
                    <li><strong>Tap</strong> on bricks to break them and earn cash</li>
                    <li><strong>Tap</strong> shop buttons to purchase balls and upgrades</li>
                    <li><strong>Swipe</strong> through menus to manage your idle empire</li>
                </ul>
            </div>

            <h3>⚾ Ball Types Guide</h3>
            <div style="background: rgba(0,0,0,0.3); padding: 20px; border-radius: 10px; margin: 20px 0;">
                <p style="margin-bottom: 15px;">Each ball type has unique abilities to help you smash bricks:</p>
                <div style="display: flex; gap: 10px; flex-wrap: wrap;">
                    <span class="difficulty-badge difficulty-easy">Basic</span>
                    <span class="difficulty-badge difficulty-easy">Plasma</span>
                    <span class="difficulty-badge difficulty-medium">Sniper</span>
                    <span class="difficulty-badge difficulty-medium">Scatter</span>
                    <span class="difficulty-badge difficulty-hard">Cannon</span>
                    <span class="difficulty-badge difficulty-insane">Poison</span>
                </div>
            </div>

            <h3>💡 Tips &amp; Strategies</h3>
            <ul style="color: #f8f9fa; font-size: 16px; font-weight: 500; line-height: 1.7; padding-left: 20px;">
                <li>Don't hoard your money — spend it on balls and upgrades as soon as you can afford them!</li>
                <li>Start with Basic Balls, then work your way up to Plasma Balls for splash damage</li>
                <li>Use Sniper Balls for high single-target damage, especially on boss bricks</li>
                <li>Save power-ups for boss fights where progress might stall</li>
                <li>Use the Prestige system when progress slows — permanent bonuses make future runs faster</li>
                <li>The game runs even when you're idle, so check back to reinvest your earnings!</li>
            </ul>

            <h3>⚾ Detailed Ball Breakdown</h3>
            <ul style="color: #f8f9fa; font-size: 16px; font-weight: 500; line-height: 1.7; padding-left: 20px;">
                <li><strong>Basic Ball:</strong> Cheap and simple — a great starting point, but upgrade quickly</li>
                <li><strong>Plasma Ball:</strong> Deals splash damage to nearby bricks, hitting multiple targets at once</li>
                <li><strong>Sniper Ball:</strong> Automatically retargets the nearest brick — ideal for picking off stragglers</li>
                <li><strong>Scatter Ball:</strong> Splits into multiple balls on impact, clearing wide areas of bricks</li>
                <li><strong>Cannonball:</strong> Pure damage powerhouse that smashes through a series of bricks in a line</li>
                <li><strong>Poison Ball:</strong> Infects bricks on contact, dealing damage over time and spreading to neighbors</li>
            </ul>

            <h3>🏆 Progression &amp; Power-Ups</h3>
            <ul style="color: #f8f9fa; font-size: 16px; font-weight: 500; line-height: 1.7; padding-left: 20px;">
                <li><strong>Upgrades:</strong> Increase ball speed, power, and click damage from the upgrade menu</li>
                <li><strong>Boss Fights:</strong> Appear every few levels — defeat them for Skill Points and new content</li>
                <li><strong>Power-Ups:</strong> Unlock time-limited boosts like Click Frenzy, Demon Core, and 2x Gold</li>
                <li><strong>Prestige:</strong> Reset your progress for permanent multipliers that stack over time</li>
                <li><strong>Offline Earnings:</strong> The game keeps earning cash while you're away — come back to big profits!</li>
            </ul>
            ...
            <div style="background: linear-gradient(135deg, rgba(0,191,255,0.2), rgba(255,215,0,0.2)); border: 2px solid #FFD700; border-radius: 10px; padding: 20px; margin-top: 25px; text-align: center;">
                ...
                <p style="color: #f8f9fa; font-weight: 500; margin: 0;">Break 1,000,000 bricks to unlock a hidden surprise sound effect! Also, don't sleep on the Prestige system — strategic resets are the key to reaching the highest levels and unlocking all achievements!</p>
            </div>
        </div>
    </div>
    ...
    <div id="reportGameModal" style="display:none;position:fixed;inset:0;z-index:9999;background:rgba(0,0,0,0.8);align-items:center;justify-content:center;padding:20px;">
        <div style="background:linear-gradient(135deg,#0f172a,#1e293b);border:1px solid rgba(239,68,68,0.3);border-radius:14px;padding:28px;max-width:440px;width:100%;color:#e2e8f0;">
            ...
            <p style="color:#94a3b8;font-size:0.85rem;margin-bottom:14px;">Game: <strong>idleb</strong></p>
            ...
            <div style="display:flex;gap:8px;">
                <button onclick="submitGameReport('idleb')" style="flex:1;padding:10px;border:none;border-radius:8px;background:linear-gradient(135deg,#ef4444,#dc2626);color:#fff;font-weight:600;cursor:pointer;">Submit Report</button>
