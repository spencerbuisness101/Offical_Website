...
<head>
    ...
    <meta name="description" content="Play Retro Bowl - Spencer's Game Collection">
    <title>Retro Bowl - Spencer's Website</title>
...
<div class="container">
    ...
    <header class="page-header">
        <h1>🏈 Retro Bowl <span class="game-badge">Sports Game</span></h1>
        <p>Experience classic football action in this addictive retro-style sports game!</p>
    </header>

    <!-- Retro Bowl Game Player -->
    <div class="game-player">
        <div class="game-container" id="gameContainer">
            ...
            <iframe 
                ...
                loading="lazy"
                src="https://searchprox.global.ssl.fastly.net/public/assets/games/retro-bowl/" 
                ...
                frameborder="0"
                id="gameIframe"
                title="Retro Bowl Football Game"
            ></iframe>
        </div>
        
        <div class="game-details">
            <h2>🎯 About Retro Bowl</h2>
            <p>Retro Bowl is an exciting American football game with retro-style graphics and addictive gameplay. Build your dream team, manage your roster, and lead them to victory in this strategic sports simulation!</p>
            
            <h3>⭐ Game Features</h3>
            <div class="features-grid">
                <div class="feature-item">
                    <strong>🏈 Authentic Football</strong>
                    <p>Realistic football gameplay with passing, running, and defense</p>
                </div>
                <div class="feature-item">
                    <strong>📊 Team Management</strong>
                    <p>Build and manage your team roster with different player types</p>
                </div>
                <div class="feature-item">
                    <strong>🎮 Simple Controls</strong>
                    <p>Easy to learn but challenging to master gameplay</p>
                </div>
                <div class="feature-item">
                    <strong>🏆 Championship Mode</strong>
                    <p>Compete for the Retro Bowl championship trophy</p>
                </div>
            </div>
            ...
            <div style="background: linear-gradient(135deg, rgba(255,255,255,0.1) 0%, rgba(255,107,107,0.1) 100%); padding: 20px; border-radius: 10px; border-left: 5px solid #4ECDC4; margin: 20px 0;">
                <p><strong>Offensive Controls:</strong></p>
                <ul>
                    <li><strong>Tap and Drag</strong> - Aim your pass to receivers</li>
                    <li><strong>Release</strong> - Throw the football to open players</li>
                    <li><strong>Swipe</strong> - Control your runner's direction</li>
                    <li><strong>Strategy</strong> - Choose plays and manage your team</li>
                </ul>
                
                <p><strong>Defensive Controls:</strong></p>
                <ul>
                    <li><strong>Tap Players</strong> - Switch between defenders</li>
                    <li><strong>Swipe</strong> - Move defenders to tackle opponents</li>
                    <li><strong>Timing</strong> - Intercept passes and force fumbles</li>
                </ul>
            </div>

            <h3>💡 Gameplay Tips</h3>
            <ul style="color: #f8f9fa; font-size: 16px; font-weight: 500; line-height: 1.7; padding-left: 20px;">
                <li>Balance your <strong>passing and running game</strong> to keep defenses guessing</li>
                <li>Upgrade your <strong>team facilities</strong> to attract better players</li>
                <li>Manage your <strong>salary cap</strong> carefully to build a balanced roster</li>
                <li>Watch for <strong>open receivers</strong> and don't force passes into coverage</li>
                <li>Use <strong>different play types</strong> to exploit defensive weaknesses</li>
                <li>Practice <strong>timing your throws</strong> for maximum accuracy</li>
            </ul>

            <h3>🏆 Game Modes</h3>
            <ul style="color: #f8f9fa; font-size: 16px; font-weight: 500; line-height: 1.7; padding-left: 20px;">
                <li><strong>Season Mode</strong> - Play through a full football season</li>
                <li><strong>Playoffs</strong> - Compete for the championship trophy</li>
                <li><strong>Team Management</strong> - Build your dream roster</li>
                <li><strong>Player Development</strong> - Train and upgrade your athletes</li>
                <li><strong>Strategy Planning</strong> - Choose offensive and defensive plays</li>
            </ul>
            ...
            <div style="background: linear-gradient(135deg, rgba(255,107,107,0.2), rgba(78,205,196,0.2)); border: 2px solid #FF6B6B; border-radius: 10px; padding: 20px; margin-top: 25px; text-align: center;">
                ...
                <p style="color: #f8f9fa; font-weight: 500; margin: 0;">The key to winning in Retro Bowl is balancing your offense. Mix up running and passing plays to keep the defense off balance, and always look for mismatches in coverage!</p>
            </div>
        </div>
    </div>
    ...
    <div id="reportGameModal" style="display:none;position:fixed;inset:0;z-index:9999;background:rgba(0,0,0,0.8);align-items:center;justify-content:center;padding:20px;">
        <div style="background:linear-gradient(135deg,#0f172a,#1e293b);border:1px solid rgba(239,68,68,0.3);border-radius:14px;padding:28px;max-width:440px;width:100%;color:#e2e8f0;">
            ...
            <p style="color:#94a3b8;font-size:0.85rem;margin-bottom:14px;">Game: <strong>retro</strong></p>
            ...
            <div style="display:flex;gap:8px;">
                <button onclick="submitGameReport('retro')" style="flex:1;padding:10px;border:none;border-radius:8px;background:linear-gradient(135deg,#ef4444,#dc2626);color:#fff;font-weight:600;cursor:pointer;">Submit Report</button>
