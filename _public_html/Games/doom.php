...
<head>
    ...
    <meta name="description" content="Doom - Spencer's Game Collection">
    <title>Doom - Spencer's Website</title>
...
<body data-backgrounds='<?php echo htmlspecialchars(json_encode($available_backgrounds), ENT_QUOTES, 'UTF-8'); ?>'
    ...
    <header class="page-header">
        <h1>👹 Doom <span class="game-badge">FPS Classic</span></h1>
        <p>The pioneering first-person shooter that defined a genre!</p>
    </header>
    ...
    <div class="game-player">
        <div class="game-container" id="gameContainer">
            ...
            <iframe
                ...
                loading="lazy"
                src="https://thespencergamingwebsite.com/cldoomdos.html"
        ...
        <div class="game-details">
            <h2>👹 About Doom</h2>
            <p>Doom is the legendary first-person shooter that revolutionized gaming. As a space marine, battle through hordes of demonic enemies in this classic FPS that pioneered the shooter genre and set the standard for action games to come.</p>

            <h3>⭐ Game Features</h3>
            <div class="features-grid">
                <div class="feature-item">
                    <strong>👹 Classic FPS Action</strong>
                    <p>Experience the game that defined the FPS genre</p>
                </div>
                <div class="feature-item">
                    <strong>🔫 Iconic Weapons</strong>
                    <p>Shotgun, chainsaw, BFG and more</p>
                </div>
                <div class="feature-item">
                    <strong>👿 Demonic Enemies</strong>
                    <p>Battle imps, demons, and cyberdemon bosses</p>
                </div>
                <div class="feature-item">
                    <strong>🏃 Fast-Paced Combat</strong>
                    <p>Non-stop action through hellish levels</p>
                </div>
            </div>
            ...
            <div style="background: linear-gradient(135deg, rgba(255,255,255,0.1) 0%, rgba(78,205,196,0.1) 100%); padding: 20px; border-radius: 10px; border-left: 5px solid #FF6B6B; margin: 20px 0;">
                ...
                <ul>
                    ...
                    <li>Tap to shoot</li>
                    <li>On-screen buttons for weapons</li>
                </ul>
            </div>

            <h3>💡 Gameplay Tips</h3>
            <ul style="color: #f8f9fa; font-size: 16px; font-weight: 500; line-height: 1.7; padding-left: 20px;">
                <li>Keep moving to avoid enemy projectiles</li>
                <li>Manage your ammo - don't waste the BFG on small enemies</li>
                <li>Look for secret walls with extra items</li>
                <li>Use the shotgun for close-range encounters</li>
                <li>Listen for enemy sounds to prepare for ambushes</li>
            </ul>

            <h3>🏆 Objectives</h3>
            <ul style="color: #f8f9fa; font-size: 16px; font-weight: 500; line-height: 1.7; padding-left: 20px;">
                <li>Fight through all levels of hell</li>
                <li>Find keys to unlock doors and progress</li>
                <li>Defeat the final bosses</li>
                <li>Collect weapons and power-ups</li>
                <li>Survive the demonic onslaught</li>
            </ul>
            ...
            <div style="background: linear-gradient(135deg, rgba(255,107,107,0.2), rgba(78,205,196,0.2)); border: 2px solid #4ECDC4; border-radius: 10px; padding: 20px; margin-top: 25px; text-align: center;">
                ...
                <p style="color: #f8f9fa; font-weight: 500; margin: 0;">The shotgun is your best friend - it's powerful, common ammo, and effective against most enemies!</p>
            </div>
        </div>
    ...
    <div id="reportGameModal" style="display:none;position:fixed;inset:0;z-index:9999;background:rgba(0,0,0,0.8);align-items:center;justify-content:center;padding:20px;">
        <div style="background:linear-gradient(135deg,#0f172a,#1e293b);border:1px solid rgba(239,68,68,0.3);border-radius:14px;padding:28px;max-width:440px;width:100%;color:#e2e8f0;">
            ...
            <p style="color:#94a3b8;font-size:0.85rem;margin-bottom:14px;">Game: <strong>doom</strong></p>
            ...
            <div style="display:flex;gap:8px;">
                <button onclick="submitGameReport('doom')" style="flex:1;padding:10px;border:none;border-radius:8px;background:linear-gradient(135deg,#ef4444,#dc2626);color:#fff;font-weight:600;cursor:pointer;">Submit Report</button>
