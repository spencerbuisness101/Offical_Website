...
<head>
    ...
    <meta name="description" content="Territorial.io - Spencer's Game Collection">
    <title>Territorial.io - Spencer's Website</title>
...
<body data-backgrounds='<?php echo htmlspecialchars(json_encode($available_backgrounds), ENT_QUOTES, 'UTF-8'); ?>'
    ...
    <header class="page-header">
        <h1>🗺️ Territorial.io <span class="game-badge">Multiplayer Strategy</span></h1>
        <p>Conquer the map and dominate your opponents!</p>
    </header>
    ...
    <div class="game-player">
        <div class="game-container" id="gameContainer">
            ...
            <iframe
                ...
                loading="lazy"
                src="https://thespencergamingwebsite.com/clterritorialio.html"
        ...
        <div class="game-details">
            <h2>🗺️ About Territorial.io</h2>
            <p>Territorial.io is an intense real-time strategy game where you compete to conquer territory and dominate the map. Expand your borders, battle against AI or other players, and prove your strategic prowess in this addictive multiplayer experience.</p>

            <h3>⭐ Game Features</h3>
            <div class="features-grid">
                <div class="feature-item">
                    <strong>🗺️ Map Conquest</strong>
                    <p>Expand your territory across the map</p>
                </div>
                <div class="feature-item">
                    <strong>⚔️ Real-Time Strategy</strong>
                    <p>Battle against AI or other players</p>
                </div>
                <div class="feature-item">
                    <strong>🎯 Multiple Maps</strong>
                    <p>Various map types and sizes to play on</p>
                </div>
                <div class="feature-item">
                    <strong>📊 Leaderboards</strong>
                    <p>Compete for the highest rankings</p>
                </div>
            </div>
            ...
            <div style="background: linear-gradient(135deg, rgba(255,255,255,0.1) 0%, rgba(78,205,196,0.1) 100%); padding: 20px; border-radius: 10px; border-left: 5px solid #FF6B6B; margin: 20px 0;">
                ...
                <ul>
                    <li>Click and drag to select troops</li>
                    <li>Click on territory to attack</li>
                    <li>Scroll to zoom</li>
                </ul>

                <p><strong>Mobile/Touch Controls:</strong></p>
                <ul>
                    <li>Tap and drag to select</li>
                    <li>Tap enemy territory to attack</li>
                </ul>
            </div>

            <h3>💡 Gameplay Tips</h3>
            <ul style="color: #f8f9fa; font-size: 16px; font-weight: 500; line-height: 1.7; padding-left: 20px;">
                <li>Expand quickly at the start to claim neutral territory</li>
                <li>Don't spread too thin - consolidate before attacking</li>
                <li>Attack weak neighbors first to build strength</li>
                <li>Use terrain features to your advantage</li>
                <li>Timing your attacks is crucial</li>
            </ul>

            <h3>🏆 Objectives</h3>
            <ul style="color: #f8f9fa; font-size: 16px; font-weight: 500; line-height: 1.7; padding-left: 20px;">
                <li>Conquer the entire map</li>
                <li>Defeat all opposing players/AI</li>
                <li>Control strategic points</li>
                <li>Build the largest territory</li>
                <li>Achieve total domination</li>
            </ul>
            ...
            <div style="background: linear-gradient(135deg, rgba(255,107,107,0.2), rgba(78,205,196,0.2)); border: 2px solid #4ECDC4; border-radius: 10px; padding: 20px; margin-top: 25px; text-align: center;">
                ...
                <p style="color: #f8f9fa; font-weight: 500; margin: 0;">Rapid early expansion gives you more resources - don't wait too long to start claiming territory!</p>
            </div>
        </div>
    ...
    <div id="reportGameModal" style="display:none;position:fixed;inset:0;z-index:9999;background:rgba(0,0,0,0.8);align-items:center;justify-content:center;padding:20px;">
        <div style="background:linear-gradient(135deg,#0f172a,#1e293b);border:1px solid rgba(239,68,68,0.3);border-radius:14px;padding:28px;max-width:440px;width:100%;color:#e2e8f0;">
            ...
            <p style="color:#94a3b8;font-size:0.85rem;margin-bottom:14px;">Game: <strong>territorialio</strong></p>
            ...
            <div style="display:flex;gap:8px;">
                <button onclick="submitGameReport('territorialio')" style="flex:1;padding:10px;border:none;border-radius:8px;background:linear-gradient(135deg,#ef4444,#dc2626);color:#fff;font-weight:600;cursor:pointer;">Submit Report</button>
