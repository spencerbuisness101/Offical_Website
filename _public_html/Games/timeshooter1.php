...
<head>
    ...
    <meta name="description" content="Play Time Shooter 1 - Spencer's Game Collection">
    <title>Time Shooter 1 - Spencer's Website</title>
...
<div class="container">
    ...
    <header class="page-header">
        <h1>🎮 Time Shooter 1 <span class="game-badge">Action/Puzzle</span></h1>
        <p>Time only moves when you do! Plan your moves, dodge bullets, and eliminate enemies strategically.</p>
    </header>

    <!-- Time Shooter 1 Game Player -->
    <div class="game-player">
        <div class="game-container" id="gameContainer">
            ...
            <iframe
                ...
                loading="lazy"
                src="https://c.voidnetwork.space.cdn.cloudflare.net/onlylocal/html/199.html"
        ...
        <div class="game-details">
            <h2>🎯 About Time Shooter 1</h2>
            <p>Time Shooter is a unique first-person shooter where time only moves when you do. Plan your moves carefully, dodge bullets in slow motion, and take out enemies strategically. Inspired by the SUPERHOT concept, every movement counts in this thrilling time-bending experience.</p>

            <h3>⭐ Game Features</h3>
            <div class="features-grid">
                <div class="feature-item">
                    <strong>⏰ Time-Bending Mechanic</strong>
                    <p>Time freezes when you stand still - plan your moves strategically</p>
                </div>
                <div class="feature-item">
                    <strong>🔫 Strategic Combat</strong>
                    <p>Every bullet and move matters in this tactical shooter</p>
                </div>
                <div class="feature-item">
                    <strong>🎯 Bullet Dodging</strong>
                    <p>See bullets in slow motion and weave between them</p>
                </div>
                <div class="feature-item">
                    <strong>🧩 Puzzle Meets Action</strong>
                    <p>Combine shooting skills with puzzle-like strategic thinking</p>
                </div>
            </div>
            ...
            <div style="background: linear-gradient(135deg, rgba(255,255,255,0.1) 0%, rgba(255,107,107,0.1) 100%); padding: 20px; border-radius: 10px; border-left: 5px solid #4ECDC4; margin: 20px 0;">
                ...
                <ul>
                    <li><strong>WASD / Arrow Keys</strong> - Move your character (time moves with you!)</li>
                    <li><strong>Mouse</strong> - Aim at enemies</li>
                    <li><strong>Left Click</strong> - Shoot your weapon</li>
                    <li><strong>Stand Still</strong> - Time freezes when you stop moving</li>
                </ul>

                <p><strong>Key Mechanic:</strong></p>
                <ul>
                    <li>Time <strong>only moves when you move</strong> - use this to plan attacks</li>
                    <li>Observe bullet trajectories while <strong>standing still</strong></li>
                    <li>Move strategically to <strong>dodge incoming fire</strong></li>
                    <li>Pick up <strong>weapons from fallen enemies</strong></li>
                </ul>
            </div>

            <h3>💡 Gameplay Tips</h3>
            <ul style="color: #f8f9fa; font-size: 16px; font-weight: 500; line-height: 1.7; padding-left: 20px;">
                <li><strong>Stop and observe</strong> before making your next move - time is on your side</li>
                <li>Watch for <strong>bullet trails</strong> to plan your dodging path</li>
                <li>Take out <strong>the closest enemies first</strong> to reduce immediate threats</li>
                <li>Use <strong>small movements</strong> to inch time forward and see what enemies do</li>
                <li>Pick up <strong>enemy weapons</strong> when yours runs out of ammo</li>
            </ul>

            <h3>🏆 Objectives</h3>
            <ul style="color: #f8f9fa; font-size: 16px; font-weight: 500; line-height: 1.7; padding-left: 20px;">
                <li>Eliminate all enemies in each level</li>
                <li>Dodge bullets using the time-freeze mechanic</li>
                <li>Progress through increasingly challenging stages</li>
                <li>Master the art of strategic movement and timing</li>
                <li>Complete all levels with maximum efficiency</li>
            </ul>
            ...
            <div style="background: linear-gradient(135deg, rgba(255,107,107,0.2), rgba(78,205,196,0.2)); border: 2px solid #FF6B6B; border-radius: 10px; padding: 20px; margin-top: 25px; text-align: center;">
                ...
                <p style="color: #f8f9fa; font-weight: 500; margin: 0;">Remember: time only moves when you do! Use tiny movements to scout the battlefield, then commit to decisive actions. The best strategy is patience combined with precise execution.</p>
            </div>
        </div>
    </div>
    ...
    <div id="reportGameModal" style="display:none;position:fixed;inset:0;z-index:9999;background:rgba(0,0,0,0.8);align-items:center;justify-content:center;padding:20px;">
        <div style="background:linear-gradient(135deg,#0f172a,#1e293b);border:1px solid rgba(239,68,68,0.3);border-radius:14px;padding:28px;max-width:440px;width:100%;color:#e2e8f0;">
            ...
            <p style="color:#94a3b8;font-size:0.85rem;margin-bottom:14px;">Game: <strong>timeshooter1</strong></p>
            ...
            <div style="display:flex;gap:8px;">
                <button onclick="submitGameReport('timeshooter1')" style="flex:1;padding:10px;border:none;border-radius:8px;background:linear-gradient(135deg,#ef4444,#dc2626);color:#fff;font-weight:600;cursor:pointer;">Submit Report</button>
