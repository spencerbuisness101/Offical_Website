...
<head>
    ...
    <meta name="description" content="Play Funny Shooter 2 - Spencer's Game Collection">
    <title>Funny Shooter 2 - Spencer's Website</title>
...
<div class="container">
    ...
    <header class="page-header">
        <h1>🎮 Funny Shooter 2 <span class="game-badge">Action/Shooter</span></h1>
        <p>Blast through waves of wacky ragdoll enemies in this hilarious first-person shooter!</p>
    </header>

    <!-- Funny Shooter 2 Game Player -->
    <div class="game-player">
        <div class="game-container" id="gameContainer">
            ...
            <iframe
                ...
                loading="lazy"
                src="https://thespencergamingwebsite.com/clfunnyshooter2.html"
        ...
        <div class="game-details">
            <h2>🎯 About Funny Shooter 2</h2>
            <p>Funny Shooter 2 is a hilarious first-person shooter with wacky ragdoll enemies. Blast through waves of goofy characters with an arsenal of weapons. Each enemy reacts with over-the-top ragdoll physics, making every elimination entertaining and unique.</p>

            <h3>⭐ Game Features</h3>
            <div class="features-grid">
                <div class="feature-item">
                    <strong>🤣 Hilarious Ragdoll Physics</strong>
                    <p>Watch enemies fly and flop with comedic physics effects</p>
                </div>
                <div class="feature-item">
                    <strong>🔫 Arsenal of Weapons</strong>
                    <p>Unlock and use a variety of crazy weapons to fight enemies</p>
                </div>
                <div class="feature-item">
                    <strong>🌊 Wave-Based Survival</strong>
                    <p>Survive increasingly difficult waves of wacky enemies</p>
                </div>
                <div class="feature-item">
                    <strong>🎨 Goofy Art Style</strong>
                    <p>Colorful and fun visuals that keep the action lighthearted</p>
                </div>
            </div>
            ...
            <div style="background: linear-gradient(135deg, rgba(255,255,255,0.1) 0%, rgba(255,107,107,0.1) 100%); padding: 20px; border-radius: 10px; border-left: 5px solid #4ECDC4; margin: 20px 0;">
                ...
                <p><strong>Combat Controls:</strong></p>
                <ul>
                    <li><strong>Mouse</strong> - Aim at enemies</li>
                    <li><strong>Left Click</strong> - Shoot weapon</li>
                    <li><strong>Number Keys (1-9)</strong> - Switch between weapons</li>
            ...
            <ul style="color: #f8f9fa; font-size: 16px; font-weight: 500; line-height: 1.7; padding-left: 20px;">
                <li>Keep <strong>moving constantly</strong> to avoid being surrounded by enemies</li>
                <li>Use <strong>different weapons</strong> for different enemy types and situations</li>
                <li>Aim for <strong>headshots</strong> for maximum damage and hilarious ragdoll effects</li>
                <li>Save <strong>powerful weapons</strong> for tougher waves and boss enemies</li>
                <li>Watch your <strong>ammo count</strong> and reload during safe moments</li>
            </ul>

            <h3>🏆 Objectives</h3>
            <ul style="color: #f8f9fa; font-size: 16px; font-weight: 500; line-height: 1.7; padding-left: 20px;">
                <li>Survive as many waves as possible</li>
                <li>Eliminate all enemies in each wave to progress</li>
                <li>Unlock new weapons and upgrades</li>
                <li>Achieve the highest score possible</li>
                <li>Enjoy the hilarious ragdoll physics along the way</li>
            </ul>
            ...
            <div style="background: linear-gradient(135deg, rgba(255,107,107,0.2), rgba(78,205,196,0.2)); border: 2px solid #FF6B6B; border-radius: 10px; padding: 20px; margin-top: 25px; text-align: center;">
                ...
                <p style="color: #f8f9fa; font-weight: 500; margin: 0;">Circle-strafe around groups of enemies while firing to stay safe and maximize damage. The ragdoll physics make it easy to lose track of threats, so always keep moving!</p>
            </div>
        </div>
    </div>
    ...
    <div id="reportGameModal" style="display:none;position:fixed;inset:0;z-index:9999;background:rgba(0,0,0,0.8);align-items:center;justify-content:center;padding:20px;">
        <div style="background:linear-gradient(135deg,#0f172a,#1e293b);border:1px solid rgba(239,68,68,0.3);border-radius:14px;padding:28px;max-width:440px;width:100%;color:#e2e8f0;">
            ...
            <p style="color:#94a3b8;font-size:0.85rem;margin-bottom:14px;">Game: <strong>funnyshooter2</strong></p>
            ...
            <div style="display:flex;gap:8px;">
                <button onclick="submitGameReport('funnyshooter2')" style="flex:1;padding:10px;border:none;border-radius:8px;background:linear-gradient(135deg,#ef4444,#dc2626);color:#fff;font-weight:600;cursor:pointer;">Submit Report</button>
