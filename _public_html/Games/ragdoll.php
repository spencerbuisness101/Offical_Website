...
<head>
    ...
    <meta name="description" content="Play Ragdoll Archers - Spencer's Game Collection">
    <title>Ragdoll Archers - Spencer's Website</title>
...
<body data-backgrounds='<?php echo htmlspecialchars(json_encode($available_backgrounds), ENT_QUOTES, 'UTF-8'); ?>' 
    ...
    <header class="page-header">
        <h1>🏹 About Ragdoll Archers <span class="game-badge">🏹 Action-Based</span></h1>
        <p>Navigate through challenging levels in this fast-paced Action game!</p>
    </header>
    ...
    <div class="game-player">
        <div class="game-container" id="gameContainer">
            ...
            <iframe 
                ...
                loading="lazy"
                src="https://thespencergamingwebsite.com/clragdollarchers.html" 
...
<div class="game-details">
    ...
    <p>Ragdoll Archers is a fun and chaotic physics-based archery game where floppy stickman characters battle using bows and arrows. Aim carefully, manage your stamina, and knock out your opponent in hilarious ragdoll-style combat!</p>
    
    <h3>⭐ Game Features</h3>
    <div class="features-grid">
        <div class="feature-item">
            <strong>🏹 Physics-Based Archery</strong>
            <p>Every shot is affected by gravity, force, and timing</p>
        </div>
        <div class="feature-item">
            <strong>😂 Ragdoll Combat</strong>
            <p>Unpredictable and funny character movements</p>
        </div>
        <div class="feature-item">
            <strong>⚡ Stamina System</strong>
            <p>Manage energy to shoot, jump, and survive longer</p>
        </div>
        <div class="feature-item">
            <strong>🎯 Multiple Game Modes</strong>
            <p>Play solo, co-op, or battle against AI opponents</p>
        </div>
    </div>
    ...
    <div style="background: linear-gradient(135deg, rgba(255,255,255,0.1) 0%, rgba(78,205,196,0.1) 100%); padding: 20px; border-radius: 10px; border-left: 5px solid #FF6B6B; margin: 20px 0;">
        ...
        <ul>
            <li><strong>Mouse</strong> to aim and control shot power</li>
            <li><strong>Hold & Release</strong> to shoot arrows</li>
            <li>Jump and move to dodge incoming attacks</li>
            <li>Defeat your opponent to win the round</li>
        </ul>
        
        <p><strong>Mobile/Touch Controls:</strong></p>
        <ul>
            <li><strong>Tap & Drag</strong> to aim your bow</li>
            <li>Release to fire arrows</li>
            <li>Smooth and responsive touch controls</li>
        </ul>
    </div>

    <h3>💡 Gameplay Tips</h3>
    <ul style="color: #f8f9fa; font-size: 16px; font-weight: 500; line-height: 1.7; padding-left: 20px;">
        <li>Aim for the head to deal maximum damage</li>
        <li>Watch your stamina — overusing it leaves you vulnerable</li>
        <li>Use terrain and movement to avoid arrows</li>
        <li>Time your shots instead of spamming</li>
        <li>Physics can be unpredictable — adapt quickly</li>
    </ul>

    <h3>🏆 Objectives</h3>
    <ul style="color: #f8f9fa; font-size: 16px; font-weight: 500; line-height: 1.7; padding-left: 20px;">
        <li>Defeat your opponent using archery skills</li>
        <li>Survive longer than your enemy</li>
        <li>Master aiming and stamina control</li>
        <li>Win matches across different modes</li>
        <li>Improve your accuracy and timing</li>
    </ul>
    ...
    <div style="background: linear-gradient(135deg, rgba(255,107,107,0.2), rgba(78,205,196,0.2)); border: 2px solid #4ECDC4; border-radius: 10px; padding: 20px; margin-top: 25px; text-align: center;">
        ...
        <p style="color: #f8f9fa; font-weight: 500; margin: 0;">Patience wins fights — line up your shot and let physics do the rest!</p>
    </div>
</div>
    ...
    <div id="reportGameModal" style="display:none;position:fixed;inset:0;z-index:9999;background:rgba(0,0,0,0.8);align-items:center;justify-content:center;padding:20px;">
        <div style="background:linear-gradient(135deg,#0f172a,#1e293b);border:1px solid rgba(239,68,68,0.3);border-radius:14px;padding:28px;max-width:440px;width:100%;color:#e2e8f0;">
            ...
            <p style="color:#94a3b8;font-size:0.85rem;margin-bottom:14px;">Game: <strong>ragdoll</strong></p>
            ...
            <div style="display:flex;gap:8px;">
                <button onclick="submitGameReport('ragdoll')" style="flex:1;padding:10px;border:none;border-radius:8px;background:linear-gradient(135deg,#ef4444,#dc2626);color:#fff;font-weight:600;cursor:pointer;">Submit Report</button>
