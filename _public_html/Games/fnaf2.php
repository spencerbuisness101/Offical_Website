<?php
/**
 * Five Nights at Freddy's 2 - Game Page
 */
...
<head>
    ...
    <meta name="description" content="Five Nights at Freddy's 2 - Spencer's Game Collection">
    <title>FNAF 2 - Spencer's Website</title>
...
<body data-backgrounds='<?php echo htmlspecialchars(json_encode($available_backgrounds), ENT_QUOTES, 'UTF-8'); ?>' data-active-background='<?php echo $active_designer_background ? htmlspecialchars($active_designer_background['image_url'], ENT_QUOTES, 'UTF-8') : ''; ?>'>
    ...
    <header class="page-header">
        <h1>Five Nights at Freddy's 2 <span class="game-badge">FNAF</span></h1>
        <p>The sequel with new animatronics and no doors!</p>
    </header>
    ...
    <div class="game-player">
        <div class="game-container" id="gameContainer">
            ...
            <iframe class="game-iframe"
                ...
                loading="lazy" src="https://thespencergamingwebsite.com/clfnaf2.html" allow="autoplay; encrypted-media; fullscreen" allowfullscreen id="gameIframe"></iframe>
        </div>

        <div class="game-details">
            <h2>About Five Nights at Freddy's 2</h2>
            <p>Five Nights at Freddy's 2 is the terrifying sequel to the original horror game. Set in a new location with new animatronics, you must survive five nights without security doors - only a Freddy Fazbear mask to fool the animatronics!</p>

            <h3>Game Features</h3>
            <div class="features-grid">
                <div class="feature-item"><strong>New Animatronics</strong><p>Face the Toy animatronics and withered originals</p></div>
                <div class="feature-item"><strong>No Doors</strong><p>Use the Freddy mask and flashlight to survive</p></div>
                <div class="feature-item"><strong>Music Box</strong><p>Keep the Marionette at bay by winding the music box</p></div>
                <div class="feature-item"><strong>Intense Horror</strong><p>Even scarier than the original</p></div>
            </div>
            ...
            <div style="background: linear-gradient(135deg, rgba(255,255,255,0.1) 0%, rgba(78,205,196,0.1) 100%); padding: 20px; border-radius: 10px; border-left: 5px solid #FF6B6B; margin: 20px 0;">
                ...
                <ul>
                    <li>Mouse to look around and click buttons</li>
                    <li>Click cameras to monitor animatronics</li>
                    <li>Put on Freddy mask when animatronics are near</li>
                    <li>Use flashlight in the hallway</li>
                    <li>Wind the music box regularly!</li>
                </ul>
            </div>

            <h3>Gameplay Tips</h3>
            <ul style="color: #f8f9fa; font-size: 16px; font-weight: 500; line-height: 1.7; padding-left: 20px;">
                <li>Always keep the music box wound - the Marionette is relentless</li>
                <li>Check the vents frequently</li>
                <li>Put on the mask quickly when you see animatronics in your office</li>
                <li>Use the flashlight sparingly - it has limited battery</li>
                <li>Learn each animatronic's behavior pattern</li>
            </ul>
            ...
            <div style="background: linear-gradient(135deg, rgba(255,107,107,0.2), rgba(78,205,196,0.2)); border: 2px solid #4ECDC4; border-radius: 10px; padding: 20px; margin-top: 25px; text-align: center;">
                ...
                <p style="color: #f8f9fa; font-weight: 500; margin: 0;">This game contains jump scares and intense horror elements. Play with headphones for the full experience!</p>
            </div>
        </div>
    ...
    <div id="reportGameModal" style="display:none;position:fixed;inset:0;z-index:9999;background:rgba(0,0,0,0.8);align-items:center;justify-content:center;padding:20px;">
        <div style="background:linear-gradient(135deg,#0f172a,#1e293b);border:1px solid rgba(239,68,68,0.3);border-radius:14px;padding:28px;max-width:440px;width:100%;color:#e2e8f0;">
            ...
            <p style="color:#94a3b8;font-size:0.85rem;margin-bottom:14px;">Game: <strong>fnaf2</strong></p>
            ...
            <div style="display:flex;gap:8px;">
                <button onclick="submitGameReport('fnaf2')" style="flex:1;padding:10px;border:none;border-radius:8px;background:linear-gradient(135deg,#ef4444,#dc2626);color:#fff;font-weight:600;cursor:pointer;">Submit Report</button>
