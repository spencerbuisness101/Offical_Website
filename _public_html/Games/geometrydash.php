<?php
/**
 * Geometry Dash Lite - Game Wrapper
...
<head>
    ...
    <meta name="description" content="Play Geometry Dash Lite - Spencer's Game Collection">
    <title>Geometry Dash Lite - Spencer's Website</title>
...
<body data-backgrounds='<?php echo htmlspecialchars(json_encode($available_backgrounds), ENT_QUOTES, 'UTF-8'); ?>'
    ...
    <header class="page-header">
        <h1>🔷 Geometry Dash Lite <span class="game-badge">Rhythm Platformer</span></h1>
        <p>Jump, fly, and flip your way through dangerous passages and obstacles!</p>
    </header>
    ...
    <div class="game-player">
        <div class="game-container" id="gameContainer">
            ...
            <iframe
                ...
                loading="lazy"
                src="https://thespencergamingwebsite.com/clgdlite.html"
        ...
        <div class="game-details">
            <h2>🔷 About Geometry Dash Lite</h2>
            <p>Geometry Dash Lite is a rhythm-based platformer game where you control a cube (and other forms) through challenging obstacle courses. Sync your movements to the music, jump over spikes, avoid obstacles, and reach the finish line in this addictive and challenging game!</p>

            <h3>⭐ Game Features</h3>
            <div class="features-grid">
                <div class="feature-item">
                    <strong>🎵 Rhythm-Based Gameplay</strong>
                    <p>Music synced obstacles and challenges</p>
                </div>
                <div class="feature-item">
                    <strong>🔄 Multiple Game Modes</strong>
                    <p>Cube, ship, ball, UFO, and more!</p>
                </div>
                <div class="feature-item">
                    <strong>🏆 Progressive Difficulty</strong>
                    <p>From easy to insanely hard levels</p>
                </div>
                <div class="feature-item">
                    <strong>⭐ Practice Mode</strong>
                    <p>Learn levels with checkpoints</p>
                </div>
            </div>
            ...
            <div style="background: linear-gradient(135deg, rgba(255,255,255,0.1) 0%, rgba(0,191,255,0.1) 100%); padding: 20px; border-radius: 10px; border-left: 5px solid #00BFFF; margin: 20px 0;">
                ...
                <ul>
                    <li>Press <strong>Spacebar</strong>, <strong>Up Arrow</strong>, or <strong>Left Click</strong> to jump</li>
                    <li><strong>Hold</strong> for continuous jumping in ship/UFO/wave modes</li>
                    <li>Press <strong>P</strong> to pause the game</li>
                    <li>Press <strong>Escape</strong> to exit a level</li>
                </ul>

                <p><strong>Mobile/Touch Controls:</strong></p>
                <ul>
                    <li><strong>Tap</strong> anywhere on screen to jump</li>
                    <li><strong>Hold</strong> for continuous action in vehicle modes</li>
                </ul>
            </div>

            <h3>📊 Level Difficulties</h3>
            <div style="background: rgba(0,0,0,0.3); padding: 20px; border-radius: 10px; margin: 20px 0;">
                <p style="margin-bottom: 15px;">Geometry Dash levels are rated by difficulty:</p>
                <div style="display: flex; gap: 10px; flex-wrap: wrap;">
                    <span class="difficulty-badge difficulty-easy">Easy</span>
                    <span class="difficulty-badge difficulty-easy">Normal</span>
                    <span class="difficulty-badge difficulty-medium">Hard</span>
                    <span class="difficulty-badge difficulty-medium">Harder</span>
                    <span class="difficulty-badge difficulty-hard">Insane</span>
                    <span class="difficulty-badge difficulty-insane">Demon</span>
                </div>
            </div>

            <h3>💡 Gameplay Tips</h3>
            <ul style="color: #f8f9fa; font-size: 16px; font-weight: 500; line-height: 1.7; padding-left: 20px;">
                <li>Listen to the music - obstacles are synced to the beat!</li>
                <li>Use Practice Mode to learn difficult sections</li>
                <li>Focus on timing, not speed - the game moves automatically</li>
                <li>Watch for visual cues that indicate when to jump</li>
                <li>Don't get discouraged - this game requires patience!</li>
                <li>Learn the different vehicle mechanics (ship floats, ball toggles gravity)</li>
            </ul>

            <h3>🎯 Game Modes Explained</h3>
            <ul style="color: #f8f9fa; font-size: 16px; font-weight: 500; line-height: 1.7; padding-left: 20px;">
                <li><strong>Cube:</strong> Tap to jump, hold for multiple jumps on jump pads</li>
                <li><strong>Ship:</strong> Hold to fly up, release to descend</li>
                <li><strong>Ball:</strong> Tap to switch gravity direction</li>
                <li><strong>UFO:</strong> Tap for small upward boost</li>
                <li><strong>Wave:</strong> Hold to go up diagonally, release to go down</li>
                <li><strong>Robot:</strong> Hold to jump higher, tap for short jumps</li>
                <li><strong>Spider:</strong> Tap to teleport to the opposite surface</li>
            </ul>
            ...
            <div style="background: linear-gradient(135deg, rgba(0,191,255,0.2), rgba(255,215,0,0.2)); border: 2px solid #FFD700; border-radius: 10px; padding: 20px; margin-top: 25px; text-align: center;">
                ...
                <p style="color: #f8f9fa; font-weight: 500; margin: 0;">Turn up your volume! The music isn't just for atmosphere - it's your guide to when obstacles are coming!</p>
            </div>
        </div>
    </div>
    ...
    <div id="reportGameModal" style="display:none;position:fixed;inset:0;z-index:9999;background:rgba(0,0,0,0.8);align-items:center;justify-content:center;padding:20px;">
        <div style="background:linear-gradient(135deg,#0f172a,#1e293b);border:1px solid rgba(239,68,68,0.3);border-radius:14px;padding:28px;max-width:440px;width:100%;color:#e2e8f0;">
            ...
            <p style="color:#94a3b8;font-size:0.85rem;margin-bottom:14px;">Game: <strong>geometrydash</strong></p>
            ...
            <div style="display:flex;gap:8px;">
                <button onclick="submitGameReport('geometrydash')" style="flex:1;padding:10px;border:none;border-radius:8px;background:linear-gradient(135deg,#ef4444,#dc2626);color:#fff;font-weight:600;cursor:pointer;">Submit Report</button>
