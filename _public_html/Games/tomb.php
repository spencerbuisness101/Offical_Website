...
<head>
    ...
    <meta name="description" content="Play Tomb of the Mask - Spencer's Game Collection">
    <title>Tomb of the Mask - Spencer's Website</title>
...
<div class="container">
    ...
    <header class="page-header">
        <h1>🎮 Tomb of the Mask <span class="game-badge">Arcade Adventure</span></h1>
    ...
    <div class="game-player">
        <div class="game-container" id="gameContainer">
            ...
            <iframe 
                ...
                loading="lazy"
                src="https://searchprox.global.ssl.fastly.net/public/assets/games/tomb-of-the-mask/" 
        ...
        <div class="game-details">
            <h2>🎯 About Tomb of the Mask</h2>
            <p>Tomb of the Mask is a fast-paced arcade game where you navigate through challenging maze-like levels. Slide your character through ancient tombs, collect power-ups, avoid traps, and discover hidden secrets in this addictive endless runner!</p>
            
            <h3>⭐ Game Features</h3>
            <div class="features-grid">
                <div class="feature-item">
                    <strong>🎭 Mask Powers</strong>
                    <p>Collect different masks with unique abilities</p>
                </div>
                <div class="feature-item">
                    <strong>⚡ Fast-Paced Gameplay</strong>
                    <p>Quick reflexes and strategic thinking required</p>
                </div>
                <div class="feature-item">
                    <strong>🧩 Challenging Levels</strong>
                    <p>Procedurally generated mazes with increasing difficulty</p>
                </div>
                <div class="feature-item">
                    <strong>🌟 Power-ups & Boosters</strong>
                    <p>Collect items to enhance your abilities</p>
                </div>
            </div>
            ...
            <div style="background: linear-gradient(135deg, rgba(255,255,255,0.1) 0%, rgba(78,205,196,0.1) 100%); padding: 20px; border-radius: 10px; border-left: 5px solid #FF6B6B; margin: 20px 0;">
                ...
                <ul>
                    <li>Use <strong>Arrow Keys</strong> or <strong>WASD</strong> to move your character</li>
                    <li>Press <strong>Spacebar</strong> for special abilities (if available)</li>
                    <li>Collect <strong>coins and power-ups</strong> for higher scores</li>
                    <li>Avoid <strong>traps and enemies</strong> to survive longer</li>
                </ul>
                
                <p><strong>Mobile/Touch Controls:</strong></p>
                <ul>
                    <li><strong>Swipe</strong> in the direction you want to move</li>
                    <li><strong>Tap</strong> for special actions and power-ups</li>
                    <li>Simple and intuitive touch controls</li>
                </ul>
            </div>

            <h3>💡 Gameplay Tips</h3>
            <ul style="color: #f8f9fa; font-size: 16px; font-weight: 500; line-height: 1.7; padding-left: 20px;">
                <li>Plan your moves carefully - think several steps ahead</li>
                <li>Collect all coins and power-ups for higher scores</li>
                <li>Watch out for moving traps and enemies</li>
                <li>Use masks strategically - each has unique advantages</li>
                <li>Practice makes perfect - don't get discouraged by difficult levels!</li>
            </ul>

            <h3>🏆 Objectives</h3>
            <ul style="color: #f8f9fa; font-size: 16px; font-weight: 500; line-height: 1.7; padding-left: 20px;">
                <li>Navigate through increasingly complex maze levels</li>
                <li>Collect as many coins and power-ups as possible</li>
                <li>Avoid traps, spikes, and enemies</li>
                <li>Unlock new masks and abilities</li>
                <li>Achieve high scores and compete with friends</li>
            </ul>
            ...
            <div style="background: linear-gradient(135deg, rgba(255,107,107,0.2), rgba(78,205,196,0.2)); border: 2px solid #4ECDC4; border-radius: 10px; padding: 20px; margin-top: 25px; text-align: center;">
                ...
                <p style="color: #f8f9fa; font-weight: 500; margin: 0;">The key to high scores is maintaining momentum while carefully planning your route through each maze!</p>
            </div>
        </div>
    </div>
    ...
    <div id="reportGameModal" style="display:none;position:fixed;inset:0;z-index:9999;background:rgba(0,0,0,0.8);align-items:center;justify-content:center;padding:20px;">
        <div style="background:linear-gradient(135deg,#0f172a,#1e293b);border:1px solid rgba(239,68,68,0.3);border-radius:14px;padding:28px;max-width:440px;width:100%;color:#e2e8f0;">
            ...
            <p style="color:#94a3b8;font-size:0.85rem;margin-bottom:14px;">Game: <strong>tomb</strong></p>
            ...
            <div style="display:flex;gap:8px;">
                <button onclick="submitGameReport('tomb')" style="flex:1;padding:10px;border:none;border-radius:8px;background:linear-gradient(135deg,#ef4444,#dc2626);color:#fff;font-weight:600;cursor:pointer;">Submit Report</button>
