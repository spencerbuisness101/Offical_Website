...
<head>
    ...
    <meta name="description" content="Friday Night Funkin - Spencer's Game Collection">
    <title>Friday Night Funkin - Spencer's Website</title>
...
<body data-backgrounds='<?php echo htmlspecialchars(json_encode($available_backgrounds), ENT_QUOTES, 'UTF-8'); ?>'
    ...
    <header class="page-header">
        <h1>🎤 Friday Night Funkin <span class="game-badge">Rhythm</span></h1>
        <p>Hit the beats and win your girlfriend's heart!</p>
    </header>
    ...
    <div class="game-player">
        <div class="game-container" id="gameContainer">
            ...
            <iframe
                ...
                loading="lazy"
                src="https://thespencergamingwebsite.com/clfridaynightfunkin.html"
        ...
        <div class="game-details">
            <h2>🎤 About Friday Night Funkin</h2>
            <p>Friday Night Funkin is an exciting rhythm game where you play as Boyfriend, trying to impress your Girlfriend by defeating her father and various other opponents in musical battles. Hit the notes in time with the music to win each showdown!</p>

            <h3>⭐ Game Features</h3>
            <div class="features-grid">
                <div class="feature-item">
                    <strong>🎤 Rhythm Battles</strong>
                    <p>Compete in musical showdowns</p>
                </div>
                <div class="feature-item">
                    <strong>🎵 Catchy Music</strong>
                    <p>Original soundtrack with memorable tunes</p>
                </div>
                <div class="feature-item">
                    <strong>👫 Story Mode</strong>
                    <p>Win over your girlfriend by defeating opponents</p>
                </div>
                <div class="feature-item">
                    <strong>🎮 Multiple Weeks</strong>
            ...
            <div style="background: linear-gradient(135deg, rgba(255,255,255,0.1) 0%, rgba(78,205,196,0.1) 100%); padding: 20px; border-radius: 10px; border-left: 5px solid #FF6B6B; margin: 20px 0;">
                ...
                <ul>
                    <li>Arrow keys (Up, Down, Left, Right) to hit notes as they reach the target</li>
                    <li>Enter to select menu options</li>
                </ul>

                <p><strong>Mobile/Touch Controls:</strong></p>
                <ul>
                    <li>Tap the on-screen arrows in time with the music</li>
                </ul>
            </div>

            <h3>💡 Gameplay Tips</h3>
            <ul style="color: #f8f9fa; font-size: 16px; font-weight: 500; line-height: 1.7; padding-left: 20px;">
                <li>Focus on the beat, not just the visuals</li>
                <li>Start on easy difficulty to learn songs</li>
                <li>Watch for patterns in note sequences</li>
                <li>Don't panic during fast sections - stay calm</li>
                <li>Practice mode helps you learn difficult parts</li>
            </ul>

            <h3>🏆 Objectives</h3>
            <ul style="color: #f8f9fa; font-size: 16px; font-weight: 500; line-height: 1.7; padding-left: 20px;">
                <li>Complete all weeks in story mode</li>
                <li>Hit notes accurately to fill your health bar</li>
                <li>Defeat all musical opponents</li>
                <li>Achieve high scores on each song</li>
            ...
            <div style="background: linear-gradient(135deg, rgba(255,107,107,0.2), rgba(78,205,196,0.2)); border: 2px solid #4ECDC4; border-radius: 10px; padding: 20px; margin-top: 25px; text-align: center;">
                ...
                <p style="color: #f8f9fa; font-weight: 500; margin: 0;">Listen to the music rhythm - the notes always sync with the beat, so let your ears guide your fingers!</p>
            </div>
        </div>
    ...
    <div id="reportGameModal" style="display:none;position:fixed;inset:0;z-index:9999;background:rgba(0,0,0,0.8);align-items:center;justify-content:center;padding:20px;">
        <div style="background:linear-gradient(135deg,#0f172a,#1e293b);border:1px solid rgba(239,68,68,0.3);border-radius:14px;padding:28px;max-width:440px;width:100%;color:#e2e8f0;">
            ...
            <p style="color:#94a3b8;font-size:0.85rem;margin-bottom:14px;">Game: <strong>fridaynightfunkin</strong></p>
            ...
            <div style="display:flex;gap:8px;">
                <button onclick="submitGameReport('fridaynightfunkin')" style="flex:1;padding:10px;border:none;border-radius:8px;background:linear-gradient(135deg,#ef4444,#dc2626);color:#fff;font-weight:600;cursor:pointer;">Submit Report</button>
