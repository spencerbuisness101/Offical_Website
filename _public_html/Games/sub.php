...
<head>
    ...
    <meta name="description" content="Play Subway Surfers - Spencer's Game Collection">
    <title>Subway Surfers - Spencer's Website</title>
...
<div class="container">
    ...
    <header class="page-header">
        <h1>🎮 Subway Surfers <span class="game-badge">Endless Runner</span></h1>
        <p>Dash through the subway, dodge trains, and escape the inspector in this addictive endless runner!</p>
    </header>

    <!-- Subway Surfers Game Player -->
    <div class="game-player">
        <div class="game-container" id="gameContainer">
            ...
            <iframe 
                ...
                loading="lazy"
                src="https://searchprox.global.ssl.fastly.net/public/assets/games/subway-surfers/" 
        ...
        <div class="game-details">
            ...
            <p>Subway Surfers is an exciting endless runner game where you dash through vibrant subway tracks, dodge oncoming trains, and collect coins while being chased by an inspector and his dog. Run, jump, and slide your way to high scores in this colorful and addictive mobile game!</p>
            
            <h3>⭐ Game Features</h3>
            <div class="features-grid">
                <div class="feature-item">
                    <strong>🏃‍♂️ Endless Running</strong>
                    <p>Experience non-stop action with procedurally generated tracks</p>
                </div>
                <div class="feature-item">
                    <strong>🎨 Vibrant Worlds</strong>
                    <p>Explore colorful locations from cities around the globe</p>
                </div>
                <div class="feature-item">
                    <strong>🛹 Smooth Controls</strong>
                    <p>Intuitive swipe controls for jumping, sliding, and changing lanes</p>
                </div>
                <div class="feature-item">
                    <strong>🎯 Character Collection</strong>
                    <p>Unlock and upgrade unique characters with special abilities</p>
                </div>
            </div>
            ...
            <div style="background: linear-gradient(135deg, rgba(255,255,255,0.1) 0%, rgba(255,107,107,0.1) 100%); padding: 20px; border-radius: 10px; border-left: 5px solid #4ECDC4; margin: 20px 0;">
                ...
                <ul>
                    <li><strong>Swipe Up</strong> - Jump over obstacles and trains</li>
                    <li><strong>Swipe Down</strong> - Slide under barriers</li>
                    <li><strong>Swipe Left/Right</strong> - Change lanes to avoid obstacles</li>
                    <li><strong>Collect Coins</strong> - Gather coins to purchase upgrades</li>
                    <li><strong>Power-ups</strong> - Grab hoverboards, magnets, and other boosts</li>
                </ul>
                
                <p><strong>Mobile/Touch Controls:</strong></p>
                <ul>
                    <li><strong>Tap and Hold</strong> - Activate hoverboard when available</li>
                    <li><strong>Simple Swipes</strong> - Intuitive touch controls for all actions</li>
                    <li><strong>Auto-run</strong> - Character runs automatically, you just navigate</li>
                </ul>
            </div>

            <h3>💡 Gameplay Tips</h3>
            <ul style="color: #f8f9fa; font-size: 16px; font-weight: 500; line-height: 1.7; padding-left: 20px;">
                <li>Use <strong>hoverboards</strong> strategically when you're in tight spots</li>
                <li>Collect <strong>coin magnets</strong> to maximize your earnings</li>
                <li>Watch for <strong>daily challenges</strong> to earn extra rewards</li>
                <li>Upgrade your <strong>character abilities</strong> for better performance</li>
                <li>Learn to <strong>time your jumps</strong> perfectly over moving trains</li>
                <li>Use <strong>score multipliers</strong> to achieve higher scores faster</li>
            </ul>

            <h3>🏆 Objectives</h3>
            <ul style="color: #f8f9fa; font-size: 16px; font-weight: 500; line-height: 1.7; padding-left: 20px;">
                <li>Achieve the highest possible score in endless running mode</li>
                <li>Complete daily and weekly challenges for special rewards</li>
                <li>Collect all characters and customize them with different outfits</li>
                <li>Master all the different locations and their unique obstacles</li>
                <li>Compete with friends on the global leaderboards</li>
            </ul>
            ...
            <div style="background: linear-gradient(135deg, rgba(255,107,107,0.2), rgba(78,205,196,0.2)); border: 2px solid #FF6B6B; border-radius: 10px; padding: 20px; margin-top: 25px; text-align: center;">
                ...
                <p style="color: #f8f9fa; font-weight: 500; margin: 0;">The key to high scores in Subway Surfers is mastering the rhythm of obstacles and learning to anticipate what's coming next. Focus on collecting coin magnets and score multipliers, and save your hoverboards for when you're about to hit an obstacle you can't avoid. Remember: consistency is more important than speed!</p>
            </div>
        </div>
    </div>
    ...
    <div id="reportGameModal" style="display:none;position:fixed;inset:0;z-index:9999;background:rgba(0,0,0,0.8);align-items:center;justify-content:center;padding:20px;">
        <div style="background:linear-gradient(135deg,#0f172a,#1e293b);border:1px solid rgba(239,68,68,0.3);border-radius:14px;padding:28px;max-width:440px;width:100%;color:#e2e8f0;">
            ...
            <p style="color:#94a3b8;font-size:0.85rem;margin-bottom:14px;">Game: <strong>sub</strong></p>
            ...
            <div style="display:flex;gap:8px;">
                <button onclick="submitGameReport('sub')" style="flex:1;padding:10px;border:none;border-radius:8px;background:linear-gradient(135deg,#ef4444,#dc2626);color:#fff;font-weight:600;cursor:pointer;">Submit Report</button>
