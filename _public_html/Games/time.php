...
<head>
    ...
    <meta name="description" content="Play Time Shooter 2 - Spencer's Game Collection">
    <title>Time Shooter 2 - Spencer's Website</title>
...
<div class="container">
    ...
    <header class="page-header">
        <h1>🎮 Time Shooter 2 <span class="game-badge">Action Shooter</span></h1>
        <p>Control time itself in this intense action shooter where you slow down time to dodge bullets!</p>
    </header>

    <!-- Time Shooter 2 Game Player -->
    <div class="game-player">
        <div class="game-container" id="gameContainer">
            ...
            <iframe 
                ...
                loading="lazy"
                src="https://searchprox.global.ssl.fastly.net/public/assets/games/time-shooter-2/" 
        ...
        <div class="game-details">
            ...
            <p>Time Shooter 2 is an action-packed shooter where you control time itself! Slow down time to dodge enemy bullets, plan your attacks strategically, and eliminate all enemies in each level. With its unique time manipulation mechanics, this game offers a fresh take on the shooter genre.</p>
            
            <h3>⭐ Game Features</h3>
            <div class="features-grid">
                <div class="feature-item">
                    <strong>⏱️ Time Control</strong>
                    <p>Slow down time to dodge bullets and plan your moves</p>
                </div>
                <div class="feature-item">
                    <strong>🔫 Weapon Variety</strong>
                    <p>Unlock and upgrade different weapons with unique abilities</p>
                </div>
                <div class="feature-item">
                    <strong>🎯 Challenging Levels</strong>
                    <p>Progress through increasingly difficult levels with unique enemies</p>
                </div>
                <div class="feature-item">
                    <strong>⚡ Fast-Paced Action</strong>
                    <p>Intense combat that tests your reflexes and strategic thinking</p>
                </div>
                <div class="feature-item">
                    <strong>🏆 Score System</strong>
                    <p>Compete for high scores with combo multipliers and style points</p>
                </div>
                <div class="feature-item">
                    <strong>🎮 Smooth Controls</strong>
                    <p>Responsive controls optimized for both desktop and mobile</p>
                </div>
            </div>
            ...
            <div style="background: linear-gradient(135deg, rgba(255,255,255,0.1) 0%, rgba(255,107,107,0.1) 100%); padding: 20px; border-radius: 10px; border-left: 5px solid #4ECDC4; margin: 20px 0;">
                ...
                <ul>
                    ...
                    <li><strong>Spacebar</strong> - Slow down time</li>
                    <li><strong>R</strong> - Reload your weapon</li>
                    <li><strong>Number Keys</strong> - Switch between weapons</li>
                </ul>
                
                <p><strong>Mobile/Touch Controls:</strong></p>
                <ul>
                    <li><strong>Virtual Joystick</strong> - Move your character</li>
                    <li><strong>Tap to Shoot</strong> - Aim and fire at enemies</li>
                    <li><strong>Time Slow Button</strong> - Activate time manipulation</li>
                    <li>Intuitive touch controls optimized for mobile play</li>
                </ul>
            </div>

            <h3>💡 Gameplay Tips</h3>
            <ul style="color: #f8f9fa; font-size: 16px; font-weight: 500; line-height: 1.7; padding-left: 20px;">
                <li>Use time slow <strong>strategically</strong> - don't waste it when not needed</li>
                <li>Always be <strong>moving</strong> to avoid enemy fire</li>
                <li>Prioritize <strong>dangerous enemies</strong> first in each wave</li>
                <li>Learn enemy <strong>attack patterns</strong> to anticipate their moves</li>
                <li>Use <strong>cover</strong> when available to avoid taking damage</li>
                <li>Upgrade your weapons <strong>regularly</strong> to handle tougher enemies</li>
                <li>Try to achieve <strong>headshots</strong> for bonus points and faster kills</li>
            </ul>

            <h3>🏆 Objectives</h3>
            <ul style="color: #f8f9fa; font-size: 16px; font-weight: 500; line-height: 1.7; padding-left: 20px;">
                <li>Complete all levels with the highest rating</li>
                <li>Achieve high scores with combo multipliers</li>
                <li>Unlock all weapons and upgrades</li>
                <li>Defeat challenging boss enemies</li>
                <li>Master the time manipulation mechanics</li>
                <li>Complete levels without taking damage for bonus rewards</li>
            </ul>
            ...
            <div style="background: linear-gradient(135deg, rgba(255,107,107,0.2), rgba(78,205,196,0.2)); border: 2px solid #FF6B6B; border-radius: 10px; padding: 20px; margin-top: 25px; text-align: center;">
                ...
                <p style="color: #f8f9fa; font-weight: 500; margin: 0;">The key to mastering Time Shooter 2 is learning when to use your time slow ability. Save it for moments when you're surrounded or need to dodge a difficult attack pattern!</p>
            </div>
        </div>
    </div>
    ...
    <div id="reportGameModal" style="display:none;position:fixed;inset:0;z-index:9999;background:rgba(0,0,0,0.8);align-items:center;justify-content:center;padding:20px;">
        <div style="background:linear-gradient(135deg,#0f172a,#1e293b);border:1px solid rgba(239,68,68,0.3);border-radius:14px;padding:28px;max-width:440px;width:100%;color:#e2e8f0;">
            ...
            <p style="color:#94a3b8;font-size:0.85rem;margin-bottom:14px;">Game: <strong>time</strong></p>
            ...
            <div style="display:flex;gap:8px;">
                <button onclick="submitGameReport('time')" style="flex:1;padding:10px;border:none;border-radius:8px;background:linear-gradient(135deg,#ef4444,#dc2626);color:#fff;font-weight:600;cursor:pointer;">Submit Report</button>
