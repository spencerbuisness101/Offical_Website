...
<head>
    ...
    <meta name="description" content="Final Earth 2 - Spencer's Game Collection">
    <title>Final Earth 2 - Spencer's Website</title>
...
<body data-backgrounds='<?php echo htmlspecialchars(json_encode($available_backgrounds), ENT_QUOTES, 'UTF-8'); ?>'
    ...
    <header class="page-header">
        <h1>🌍 Final Earth 2 <span class="game-badge">City Builder</span></h1>
        <p>Build your civilization across the galaxy!</p>
    </header>
    ...
    <div class="game-player">
        <div class="game-container" id="gameContainer">
            ...
            <iframe
                ...
                loading="lazy"
                src="https://thespencergamingwebsite.com/clfinalearth2.html"
        ...
        <div class="game-details">
            <h2>🌍 About Final Earth 2</h2>
            <p>Final Earth 2 is an epic city-building simulation where you start with a small settlement and grow it into a thriving interplanetary civilization. Manage resources, grow your population, research new technologies, and expand beyond Earth to colonize new worlds across the galaxy!</p>

            <h3>⭐ Game Features</h3>
            <div class="features-grid">
                <div class="feature-item">
                    <strong>🏙️ City Building</strong>
                    <p>Construct buildings, roads, and infrastructure</p>
                </div>
                <div class="feature-item">
                    <strong>🚀 Space Expansion</strong>
                    <p>Colonize other planets when Earth is full</p>
                </div>
                <div class="feature-item">
                    <strong>👷 Population Growth</strong>
                    <p>Manage citizens and assign them to jobs</p>
                </div>
                <div class="feature-item">
                    <strong>🔬 Research & Tech</strong>
                    <p>Unlock new buildings and technologies</p>
                </div>
            </div>
            ...
            <div style="background: linear-gradient(135deg, rgba(255,255,255,0.1) 0%, rgba(78,205,196,0.1) 100%); padding: 20px; border-radius: 10px; border-left: 5px solid #FF6B6B; margin: 20px 0;">
                ...
                <ul>
                    ...
                    <li>Click buildings to manage</li>
                </ul>
            ...
            <ul style="color: #f8f9fa; font-size: 16px; font-weight: 500; line-height: 1.7; padding-left: 20px;">
                <li>Start with housing and food production</li>
                <li>Balance residential and industrial buildings</li>
                <li>Upgrade buildings to increase efficiency</li>
                <li>Don't overcrowd - expand to new planets when needed</li>
                <li>Keep unemployment low for a happy population</li>
            </ul>

            <h3>🏆 Objectives</h3>
            <ul style="color: #f8f9fa; font-size: 16px; font-weight: 500; line-height: 1.7; padding-left: 20px;">
                <li>Grow your population to millions</li>
                <li>Expand across multiple planets</li>
                <li>Research all available technologies</li>
                <li>Build efficient transportation networks</li>
                <li>Create a thriving interplanetary civilization</li>
            </ul>
            ...
            <div style="background: linear-gradient(135deg, rgba(255,107,107,0.2), rgba(78,205,196,0.2)); border: 2px solid #4ECDC4; border-radius: 10px; padding: 20px; margin-top: 25px; text-align: center;">
                ...
                <p style="color: #f8f9fa; font-weight: 500; margin: 0;">Food and housing are your priorities - without them, your population can't grow!</p>
            </div>
        </div>
    ...
    <div id="reportGameModal" style="display:none;position:fixed;inset:0;z-index:9999;background:rgba(0,0,0,0.8);align-items:center;justify-content:center;padding:20px;">
        <div style="background:linear-gradient(135deg,#0f172a,#1e293b);border:1px solid rgba(239,68,68,0.3);border-radius:14px;padding:28px;max-width:440px;width:100%;color:#e2e8f0;">
            ...
            <p style="color:#94a3b8;font-size:0.85rem;margin-bottom:14px;">Game: <strong>finalearth2</strong></p>
            ...
            <div style="display:flex;gap:8px;">
                <button onclick="submitGameReport('finalearth2')" style="flex:1;padding:10px;border:none;border-radius:8px;background:linear-gradient(135deg,#ef4444,#dc2626);color:#fff;font-weight:600;cursor:pointer;">Submit Report</button>
