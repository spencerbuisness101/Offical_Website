...
<head>
    ...
    <meta name="description" content="Play Retro Bowl College - Spencer's Game Collection">
    <title>Retro Bowl College - Spencer's Website</title>
...
<div class="container">
    ...
    <header class="page-header">
        <h1>🎮 Retro Bowl College <span class="game-badge">Football Game</span></h1>
        <p>Experience college football in this retro-style sports game!</p>
    </header>

    <!-- Retro Bowl College Game Player -->
    <div class="game-player">
        <div class="game-container" id="gameContainer">
            ...
            <iframe 
                ...
                loading="lazy"
                src="https://searchprox.global.ssl.fastly.net/public/assets/games/retro-bowl-college/" 
        ...
        <div class="game-details">
            <h2>🎯 About Retro Bowl College</h2>
            <p>Retro Bowl College brings the excitement of college football to the retro gaming world! Build your dream college football program, recruit top talent, and lead your team to national championship glory in this addictive sports management game.</p>
            
            <h3>⭐ Game Features</h3>
            <div class="features-grid">
                <div class="feature-item">
                    <strong>🏈 College Football</strong>
                    <p>Experience the passion of college football season</p>
                </div>
                <div class="feature-item">
                    <strong>📊 Team Management</strong>
                    <p>Recruit players and build your championship roster</p>
                </div>
                <div class="feature-item">
                    <strong>🎮 Retro Gameplay</strong>
                    <p>Classic arcade-style football action</p>
                </div>
                <div class="feature-item">
                    <strong>🏆 Championships</strong>
                    <p>Compete for conference titles and national championships</p>
                </div>
                <div class="feature-item">
                    <strong>👥 Player Development</strong>
                    <p>Train and develop your college athletes</p>
                </div>
                <div class="feature-item">
                    <strong>📈 Program Building</strong>
                    <p>Build your college program from the ground up</p>
                </div>
            </div>
            ...
            <div style="background: linear-gradient(135deg, rgba(255,255,255,0.1) 0%, rgba(255,107,107,0.1) 100%); padding: 20px; border-radius: 10px; border-left: 5px solid #4ECDC4; margin: 20px 0;">
                <div class="control-scheme">
                    <div class="player-controls">
                        <h4 style="color: #FF6B6B; margin-bottom: 15px;">🎮 Offensive Controls</h4>
                        <ul style="color: #f8f9fa; font-size: 16px; font-weight: 500; line-height: 1.7; padding-left: 20px;">
                            <li><strong>Arrow Keys / WASD</strong> - Move quarterback</li>
                            <li><strong>Spacebar / Click</strong> - Throw pass</li>
                            <li><strong>A / Left Click</strong> - Hand off to running back</li>
                            <li><strong>S / Right Click</strong> - Dive/tackle</li>
                        </ul>
                    </div>
                    
                    <div class="player-controls">
                        <h4 style="color: #4ECDC4; margin-bottom: 15px;">🛡️ Defensive Controls</h4>
                        <ul style="color: #f8f9fa; font-size: 16px; font-weight: 500; line-height: 1.7; padding-left: 20px;">
                            <li><strong>Arrow Keys / WASD</strong> - Move defender</li>
                            <li><strong>Spacebar</strong> - Switch defenders</li>
                            <li><strong>S / Click</strong> - Tackle ball carrier</li>
                            <li><strong>A</strong> - Jump for interception</li>
                        </ul>
                    </div>
                </div>
                
                <p><strong>Game Objective:</strong> Build a dominant college football program by winning games, recruiting top high school players, and competing for national championships!</p>
            </div>

            <h3>💡 Gameplay Tips</h3>
            <ul style="color: #f8f9fa; font-size: 16px; font-weight: 500; line-height: 1.7; padding-left: 20px;">
                <li>Balance your recruiting between offensive and defensive players</li>
                <li>Upgrade your facilities to attract better recruits</li>
                <li>Manage your team's morale and conditioning throughout the season</li>
                <li>Mix up your playcalling to keep defenses guessing</li>
                <li>Focus on building team chemistry for better performance</li>
                <li>Don't neglect special teams - they can win or lose close games</li>
            </ul>

            <h3>🏆 Objectives & Strategies</h3>
            <ul style="color: #f8f9fa; font-size: 16px; font-weight: 500; line-height: 1.7; padding-left: 20px;">
                <li>Win your conference championship</li>
                <li>Recruit 5-star high school prospects</li>
                <li>Develop players into NFL-caliber talent</li>
                <li>Build legendary college football program</li>
                <li>Maintain high team GPA and morale</li>
                <li>Create a lasting dynasty</li>
            </ul>
            ...
            <div style="background: linear-gradient(135deg, rgba(255,107,107,0.2), rgba(78,205,196,0.2)); border: 2px solid #FF6B6B; border-radius: 10px; padding: 20px; margin-top: 25px; text-align: center;">
                ...
                <p style="color: #f8f9fa; font-weight: 500; margin: 0;">Focus on building a strong offensive line first - it will make both your passing and running games more effective. A good O-line gives your quarterback time to throw and opens running lanes for your backs!</p>
            </div>
        </div>
    </div>
    ...
    <div id="reportGameModal" style="display:none;position:fixed;inset:0;z-index:9999;background:rgba(0,0,0,0.8);align-items:center;justify-content:center;padding:20px;">
        <div style="background:linear-gradient(135deg,#0f172a,#1e293b);border:1px solid rgba(239,68,68,0.3);border-radius:14px;padding:28px;max-width:440px;width:100%;color:#e2e8f0;">
            ...
            <p style="color:#94a3b8;font-size:0.85rem;margin-bottom:14px;">Game: <strong>retro2</strong></p>
            ...
            <div style="display:flex;gap:8px;">
                <button onclick="submitGameReport('retro2')" style="flex:1;padding:10px;border:none;border-radius:8px;background:linear-gradient(135deg,#ef4444,#dc2626);color:#fff;font-weight:600;cursor:pointer;">Submit Report</button>
