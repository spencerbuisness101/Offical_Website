...
<head>
    ...
    <title>Block Blast - Spencer's Website</title>
...
<body data-backgrounds='<?php echo htmlspecialchars(json_encode($available_backgrounds), ENT_QUOTES, 'UTF-8'); ?>' 
    ...
    <header class="page-header">
        <h1>🧩 About Block Blast <span class="game-badge">Arcade Adventure (FIXED!)</span></h1>
    ...
    <div class="game-player">
        <div class="game-container" id="gameContainer">
            ...
            <iframe 
                ...
                loading="lazy"
                src="https://thespencergamingwebsite.com/clblockblast.html" 
...
<div class="game-details">
    <h2>🧩 About Block Blast</h2>
    <p>Block Blast is a relaxing yet strategic puzzle game where you drag and place blocks on a 10x10 grid. Fill rows or columns to clear them, earn points, and keep going as long as you have space. It’s simple to start but becomes more challenging as the board fills up!</p>
    
    <h3>⭐ Game Features</h3>
    <div class="features-grid">
        <div class="feature-item">
            <strong🧱 Smooth Drag & Drop</strong>
            <p>Place pieces anywhere on the board with intuitive controls</p>
        </div>
        <div class="feature-item">
            <strong>🧠 Strategy-Based Gameplay</strong>
            <p>Think ahead to avoid running out of space</p>
        </div>
        <div class="feature-item">
            <strong>🔥 Satisfying Clears</strong>
            <p>Complete rows or columns to blast blocks away</p>
        </div>
        <div class="feature-item">
            <strong>🌟 Endless Mode</strong>
            <p>Play as long as you can keep your board open</p>
        </div>
    </div>
    ...
    <div style="background: linear-gradient(135deg, rgba(255,255,255,0.1) 0%, rgba(78,205,196,0.1) 100%); padding: 20px; border-radius: 10px; border-left: 5px solid #FF6B6B; margin: 20px 0;">
        ...
        <ul>
            <li><strong>Click & Drag</strong> blocks into position</li>
            <li><strong>Release</strong> to place the block on the grid</li>
            <li>Clear full rows or columns to score points</li>
            <li>Game ends when there’s no space for any piece</li>
        </ul>
        
        <p><strong>Mobile/Touch Controls:</strong></p>
        <ul>
            <li><strong>Tap & Drag</strong> pieces with your finger</li>
            <li>Drop pieces anywhere on the board</li>
            <li>Responsive and smooth touch gameplay</li>
        </ul>
    </div>

    <h3>💡 Gameplay Tips</h3>
    <ul style="color: #f8f9fa; font-size: 16px; font-weight: 500; line-height: 1.7; padding-left: 20px;">
        <li>Always keep open spaces for bigger pieces</li>
        <li>Try to clear multiple lines at once for bonus points</li>
        <li>Avoid leaving isolated empty squares</li>
        <li>Place difficult shapes early before the board fills</li>
        <li>Stay calm — Block Blast rewards strategic thinking</li>
    </ul>

    <h3>🏆 Objectives</h3>
    <ul style="color: #f8f9fa; font-size: 16px; font-weight: 500; line-height: 1.7; padding-left: 20px;">
        <li>Score as many points as possible</li>
        <li>Clear rows and columns efficiently</li>
        <li>Survive as long as you can before running out of space</li>
        <li>Use strategy to prevent the board from filling</li>
        <li>Beat your highest score!</li>
    </ul>
    ...
    <div style="background: linear-gradient(135deg, rgba(255,107,107,0.2), rgba(78,205,196,0.2)); border: 2px solid #4ECDC4; border-radius: 10px; padding: 20px; margin-top: 25px; text-align: center;">
        ...
        <p style="color: #f8f9fa; font-weight: 500; margin: 0;">Always leave room for long or awkward pieces — they can save your run or end it instantly!</p>
    </div>
</div>
    ...
    <div id="reportGameModal" style="display:none;position:fixed;inset:0;z-index:9999;background:rgba(0,0,0,0.8);align-items:center;justify-content:center;padding:20px;">
        <div style="background:linear-gradient(135deg,#0f172a,#1e293b);border:1px solid rgba(239,68,68,0.3);border-radius:14px;padding:28px;max-width:440px;width:100%;color:#e2e8f0;">
            ...
            <p style="color:#94a3b8;font-size:0.85rem;margin-bottom:14px;">Game: <strong>block</strong></p>
            ...
            <div style="display:flex;gap:8px;">
                <button onclick="submitGameReport('block')" style="flex:1;padding:10px;border:none;border-radius:8px;background:linear-gradient(135deg,#ef4444,#dc2626);color:#fff;font-weight:600;cursor:pointer;">Submit Report</button>
