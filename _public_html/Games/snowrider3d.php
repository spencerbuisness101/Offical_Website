...
<head>
    ...
    <meta name="description" content="Play Snow Rider 3D - Spencer's Game Collection">
    <title>Snow Rider 3D - Spencer's Website</title>
...
<div class="container">
    ...
    <header class="page-header">
        <h1>🎮 Snow Rider 3D <span class="game-badge">Racing/Sports</span></h1>
        <p>Ride down snowy slopes, dodge obstacles, and collect gifts in this endless snowboarding adventure!</p>
    </header>

    <!-- Snow Rider 3D Game Player -->
    <div class="game-player">
        <div class="game-container" id="gameContainer">
            ...
            <iframe
                ...
                loading="lazy"
                src="https://thespencergamingwebsite.com/clsnowrider3d.html"
        ...
        <div class="game-details">
            <h2>🎯 About Snow Rider 3D</h2>
            <p>Snow Rider 3D is an endless snowboarding game where you ride down slopes, dodge obstacles, and collect gifts while performing tricks. Glide through a beautiful winter wonderland while avoiding trees, rocks, and other hazards on your sled.</p>

            <h3>⭐ Game Features</h3>
            <div class="features-grid">
                <div class="feature-item">
                    <strong>🏔️ Endless Winter Slopes</strong>
                    <p>Ride down infinitely generated snowy mountains and trails</p>
                </div>
                <div class="feature-item">
                    <strong>🎁 Gift Collection</strong>
                    <p>Collect presents scattered across the slopes for bonus points</p>
                </div>
                <div class="feature-item">
                    <strong>🎿 Smooth 3D Graphics</strong>
                    <p>Beautiful winter scenery with smooth and responsive controls</p>
                </div>
                <div class="feature-item">
                    <strong>🏆 High Score Challenge</strong>
                    <p>Compete to travel the farthest distance without crashing</p>
                </div>
            </div>
            ...
            <div style="background: linear-gradient(135deg, rgba(255,255,255,0.1) 0%, rgba(255,107,107,0.1) 100%); padding: 20px; border-radius: 10px; border-left: 5px solid #4ECDC4; margin: 20px 0;">
                ...
                <ul>
                    <li><strong>Arrow Keys Left/Right</strong> or <strong>A/D</strong> - Steer your sled left and right</li>
                    <li><strong>Avoid obstacles</strong> - Trees, rocks, and other hazards</li>
                    <li><strong>Collect presents</strong> - Grab gift boxes for bonus points</li>
                    <li>Stay on the <strong>safe path</strong> and react quickly to obstacles</li>
                </ul>

                <p><strong>Mobile/Touch Controls:</strong></p>
                <ul>
                    <li><strong>Swipe or Tilt</strong> - Steer your sled on mobile devices</li>
                    <li>Simple <strong>one-touch controls</strong> for easy gameplay</li>
                </ul>
            </div>

            <h3>💡 Gameplay Tips</h3>
            <ul style="color: #f8f9fa; font-size: 16px; font-weight: 500; line-height: 1.7; padding-left: 20px;">
                <li>Stay in the <strong>center of the path</strong> to give yourself more reaction time</li>
                <li>Look ahead for <strong>upcoming obstacles</strong> rather than directly in front of your sled</li>
                <li>Collect <strong>gifts</strong> when safe, but prioritize survival over collection</li>
                <li>Make <strong>gentle steering adjustments</strong> instead of sharp turns</li>
                <li>The game <strong>speeds up over time</strong>, so stay focused as you progress</li>
            </ul>

            <h3>🏆 Objectives</h3>
            <ul style="color: #f8f9fa; font-size: 16px; font-weight: 500; line-height: 1.7; padding-left: 20px;">
                <li>Travel the farthest distance possible without crashing</li>
                <li>Collect as many gift boxes as you can along the way</li>
                <li>Dodge trees, rocks, and other obstacles on the slopes</li>
                <li>Beat your personal best distance record</li>
                <li>Master the controls for smooth and precise riding</li>
            </ul>
            ...
            <div style="background: linear-gradient(135deg, rgba(255,107,107,0.2), rgba(78,205,196,0.2)); border: 2px solid #FF6B6B; border-radius: 10px; padding: 20px; margin-top: 25px; text-align: center;">
                ...
                <p style="color: #f8f9fa; font-weight: 500; margin: 0;">Focus on the rhythm of the obstacles. They often appear in patterns, so once you learn to recognize them, you can anticipate what's coming and steer accordingly. Patience beats speed!</p>
            </div>
        </div>
    </div>
    ...
    <div id="reportGameModal" style="display:none;position:fixed;inset:0;z-index:9999;background:rgba(0,0,0,0.8);align-items:center;justify-content:center;padding:20px;">
        <div style="background:linear-gradient(135deg,#0f172a,#1e293b);border:1px solid rgba(239,68,68,0.3);border-radius:14px;padding:28px;max-width:440px;width:100%;color:#e2e8f0;">
            ...
            <p style="color:#94a3b8;font-size:0.85rem;margin-bottom:14px;">Game: <strong>snowrider3d</strong></p>
            ...
            <div style="display:flex;gap:8px;">
                <button onclick="submitGameReport('snowrider3d')" style="flex:1;padding:10px;border:none;border-radius:8px;background:linear-gradient(135deg,#ef4444,#dc2626);color:#fff;font-weight:600;cursor:pointer;">Submit Report</button>
