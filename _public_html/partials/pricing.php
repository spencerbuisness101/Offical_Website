<section class="pricing-section" id="pricing">
    <div class="section-header reveal">
        <span class="section-label">Tier Selection</span>
        <h2 class="section-title">Elevate Your Experience</h2>
        <p class="section-desc">From casual gamers to power users, we have a plan designed to unlock your full digital potential.</p>
    </div>

    <div class="pricing-grid">
        <!-- Community (Free) -->
        <div class="pricing-card card-community reveal">
            <div class="pricing-badge">Entry Level</div>
            <div class="pricing-name"><i class="fas fa-users tier-icon"></i> Community</div>
            <div class="pricing-price">Free</div>
            <div class="pricing-subprice">Forever, no credit card required</div>
            
            <div class="pricing-description">Essential access for those just starting their journey in our universe.</div>
            
            <ul class="pricing-features">
                <li><i class="fas fa-check"></i> Access to 70+ Core Games</li>
                <li><i class="fas fa-check"></i> Basic AI Chat (30/day)</li>
                <li><i class="fas fa-check"></i> Community Forum Access</li>
                <li><i class="fas fa-check"></i> Standard Global Ranking</li>
            </ul>
        ...
        <div class="pricing-card card-monthly reveal">
            ...
            <ul class="pricing-features">
                ...
                <li><i class="fas fa-check"></i> Unlimited AI Assistant Chat</li>
                <li><i class="fas fa-check"></i> Custom Profile & UI Themes</li>
                <li><i class="fas fa-check"></i> Priority Server Queues</li>
        ...
        <div class="pricing-card card-lifetime reveal">
            ...
            <ul class="pricing-features">
                ...
                <li><i class="fas fa-crown"></i> Permanent Lifetime Access</li>
                <li><i class="fas fa-crown"></i> "Founder" OG Profile Title</li>
                <li><i class="fas fa-crown"></i> VIP Beta Access & Voting</li>
                <li><i class="fas fa-crown"></i> Dedicated Account Manager</li>
            </ul>
        ...
        <div class="pricing-card card-bonus reveal" data-action="open-compare-modal">
            ...
            <div class="bonus-title">Detailed Comparison</div>
            <div class="bonus-desc">Need more info? View our full technical feature matrix.</div>
            <button class="pricing-cta ripple-container">Compare All Features →</button>
        </div>
    </div>
</section>
